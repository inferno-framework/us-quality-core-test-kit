...
read succeeds.
      ...
      id :us_quality_core_v100_observation_lab
      ...
      test from: :us_quality_core_v100_observation_lab_patient_category_status_search_test
      test from: :us_quality_core_v100_observation_lab_patient_category_search_test
      test from: :us_quality_core_v100_observation_lab_patient_category_date_search_test
      test from: :us_quality_core_v100_observation_lab_patient_code_search_test
      test from: :us_quality_core_v100_observation_lab_read_test
      test from: :us_quality_core_v100_observation_lab_provenance_revinclude_search_test
      test from: :us_quality_core_v100_observation_lab_validation_test
      test from: :us_quality_core_v100_observation_lab_must_support_test
      test from: :us_quality_core_v100_observation_lab_reference_resolution_test
    end
  end
end
