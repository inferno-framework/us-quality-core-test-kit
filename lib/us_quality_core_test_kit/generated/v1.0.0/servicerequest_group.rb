...
read succeeds.
      ...
      id :us_quality_core_v100_servicerequest
      ...
      test from: :us_quality_core_v100_servicerequest_patient_do_not_perform_search_test
      test from: :us_quality_core_v100_servicerequest__id_search_test
      test from: :us_quality_core_v100_servicerequest_patient_search_test
      test from: :us_quality_core_v100_servicerequest_patient_category_search_test
      test from: :us_quality_core_v100_servicerequest_patient_category_authored_search_test
      test from: :us_quality_core_v100_servicerequest_patient_code_search_test
      test from: :us_quality_core_v100_servicerequest_read_test
      test from: :us_quality_core_v100_servicerequest_provenance_revinclude_search_test
      test from: :us_quality_core_v100_servicerequest_validation_test
      test from: :us_quality_core_v100_servicerequest_must_support_test
      test from: :us_quality_core_v100_servicerequest_reference_resolution_test
    end
  end
end
