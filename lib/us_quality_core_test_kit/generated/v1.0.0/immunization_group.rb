...
module USQualityCoreTestKit
  module USQualityCoreV100
    class ImmunizationGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the capabilities required by the US Quality Core Immunization.'
...
conforming to the US Quality Core Immunization as specified in the US Quality Core Implementation Guide.
...
read succeeds.
      ...
      id :us_quality_core_v100_immunization
      ...
      test from: :us_quality_core_v100_immunization_patient_status_search_test
      test from: :us_quality_core_v100_immunization_patient_search_test
      test from: :us_quality_core_v100_immunization_read_test
      test from: :us_quality_core_v100_immunization_provenance_revinclude_search_test
      test from: :us_quality_core_v100_immunization_validation_test
      test from: :us_quality_core_v100_immunization_must_support_test
      test from: :us_quality_core_v100_immunization_reference_resolution_test
    end
  end
end
