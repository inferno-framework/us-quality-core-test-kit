...
read succeeds.
      ...
      id :us_quality_core_v100_coverage
      ...
      test from: :us_quality_core_v100_coverage_patient_search_test
      test from: :us_quality_core_v100_coverage_read_test
      test from: :us_quality_core_v100_coverage_provenance_revinclude_search_test
      test from: :us_quality_core_v100_coverage_validation_test
      test from: :us_quality_core_v100_coverage_must_support_test
      test from: :us_quality_core_v100_coverage_reference_resolution_test
    end
  end
end
