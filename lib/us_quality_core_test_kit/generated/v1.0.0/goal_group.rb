...
read succeeds.
      ...
      test from: :us_quality_core_v100_goal_patient_search_test
      test from: :us_quality_core_v100_goal_read_test
      test from: :us_quality_core_v100_goal_provenance_revinclude_search_test
      test from: :us_quality_core_v100_goal_validation_test
      test from: :us_quality_core_v100_goal_must_support_test
      test from: :us_quality_core_v100_goal_reference_resolution_test
    end
  end
end
