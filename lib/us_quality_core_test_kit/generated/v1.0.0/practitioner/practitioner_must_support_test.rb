  ...
  module USQualityCoreV100
    class PractitionerMustSupportTest < Inferno::Test
      ...
      description %(
        ...
        * Practitioner.identifier:NCSBNID
        * Practitioner.identifier:NCSBNID.system
        * Practitioner.identifier:NCSBNID.value
      ...
      id :us_quality_core_v100_practitioner_must_support_test
