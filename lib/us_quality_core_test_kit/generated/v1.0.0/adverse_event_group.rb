...
read succeeds.
      ...
      id :us_quality_core_v100_adverse_event
      ...
      test from: :us_quality_core_v100_adverse_event_subject_search_test
      test from: :us_quality_core_v100_adverse_event_subject_event_search_test
      test from: :us_quality_core_v100_adverse_event_subject_recorded_date_search_test
      test from: :us_quality_core_v100_adverse_event_read_test
      test from: :us_quality_core_v100_adverse_event_provenance_revinclude_search_test
      test from: :us_quality_core_v100_adverse_event_validation_test
      test from: :us_quality_core_v100_adverse_event_must_support_test
    end
  end
end
