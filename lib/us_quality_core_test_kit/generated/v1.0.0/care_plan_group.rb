...
module USQualityCoreTestKit
  module USQualityCoreV100
    class CarePlanGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the capabilities required by the US Quality Core CarePlan.'
...
conforming to the US Quality Core CarePlan as specified in the US Quality Core Implementation Guide.
...
read succeeds.
      ...
      id :us_quality_core_v100_care_plan
      ...
      test from: :us_quality_core_v100_care_plan_patient_category_search_test
      test from: :us_quality_core_v100_care_plan_read_test
      test from: :us_quality_core_v100_care_plan_provenance_revinclude_search_test
      test from: :us_quality_core_v100_care_plan_validation_test
      test from: :us_quality_core_v100_care_plan_must_support_test
      test from: :us_quality_core_v100_care_plan_reference_resolution_test
    end
  end
end
