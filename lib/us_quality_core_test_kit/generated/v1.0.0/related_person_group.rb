...
read succeeds.
      ...
      id :us_quality_core_v100_related_person
      ...
      test from: :us_quality_core_v100_related_person_patient_search_test
      test from: :us_quality_core_v100_related_person__id_search_test
      test from: :us_quality_core_v100_related_person_read_test
      test from: :us_quality_core_v100_related_person_provenance_revinclude_search_test
      test from: :us_quality_core_v100_related_person_validation_test
      test from: :us_quality_core_v100_related_person_must_support_test
      test from: :us_quality_core_v100_related_person_reference_resolution_test
    end
  end
end
