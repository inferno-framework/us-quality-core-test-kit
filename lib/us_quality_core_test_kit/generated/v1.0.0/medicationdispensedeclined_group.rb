...
read succeeds.
      ...
      id :us_quality_core_v100_medicationdispensedeclined
      ...
      test from: :us_quality_core_v100_medicationdispensedeclined_patient_status_search_test
      test from: :us_quality_core_v100_medicationdispensedeclined_patient_search_test
      test from: :us_quality_core_v100_medicationdispensedeclined_read_test
      test from: :us_quality_core_v100_medicationdispensedeclined_provenance_revinclude_search_test
      test from: :us_quality_core_v100_medicationdispensedeclined_validation_test
      test from: :us_quality_core_v100_medicationdispensedeclined_must_support_test
      test from: :us_quality_core_v100_medicationdispensedeclined_reference_resolution_test
    end
  end
end
