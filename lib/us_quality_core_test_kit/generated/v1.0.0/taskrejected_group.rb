...
the [US Quality Core Task Rejected Profile](http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-taskrejected). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v100_taskrejected
      ...
      test from: :us_quality_core_v100_taskrejected_patient_status_search_test
      test from: :us_quality_core_v100_taskrejected_patient_search_test
      test from: :us_quality_core_v100_taskrejected_patient_code_search_test
      test from: :us_quality_core_v100_taskrejected_read_test
      test from: :us_quality_core_v100_taskrejected_provenance_revinclude_search_test
      test from: :us_quality_core_v100_taskrejected_validation_test
      test from: :us_quality_core_v100_taskrejected_must_support_test
    end
  end
end
