...
module USQualityCoreTestKit
  module USQualityCoreV100
    class DocumentReferenceGroup < Inferno::TestGroup
      title 'US Core ADI DocumentReference Tests'
...
the [US Core ADI DocumentReference Profile Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-adi-documentreference). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v100_document_reference
      ...
      test from: :us_quality_core_v100_document_reference_patient_search_test
      test from: :us_quality_core_v100_document_reference__id_search_test
      test from: :us_quality_core_v100_document_reference_patient_type_search_test
      test from: :us_quality_core_v100_document_reference_patient_category_search_test
      test from: :us_quality_core_v100_document_reference_patient_category_date_search_test
      test from: :us_quality_core_v100_document_reference_read_test
      test from: :us_quality_core_v100_document_reference_provenance_revinclude_search_test
      test from: :us_quality_core_v100_document_reference_validation_test
      test from: :us_quality_core_v100_document_reference_must_support_test
      test from: :us_quality_core_v100_document_reference_reference_resolution_test
    end
  end
end
