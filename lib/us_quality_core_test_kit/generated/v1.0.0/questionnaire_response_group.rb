...
module USQualityCoreTestKit
  module USQualityCoreV100
    class QuestionnaireResponseGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the capabilities required by the US Quality Core QuestionnaireResponse.'
...
conforming to the US Quality Core QuestionnaireResponse as specified in the US Quality Core Implementation Guide.
...
read succeeds.
      ...
      id :us_quality_core_v100_questionnaire_response
      ...
      test from: :us_quality_core_v100_questionnaire_response_patient_search_test
      test from: :us_quality_core_v100_questionnaire_response_patient_questionnaire_search_test
      test from: :us_quality_core_v100_questionnaire_response_read_test
      test from: :us_quality_core_v100_questionnaire_response_provenance_revinclude_search_test
      test from: :us_quality_core_v100_questionnaire_response_validation_test
      test from: :us_quality_core_v100_questionnaire_response_must_support_test
      test from: :us_quality_core_v100_questionnaire_response_reference_resolution_test
    end
  end
end
