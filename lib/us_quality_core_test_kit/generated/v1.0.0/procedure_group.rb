...
module USQualityCoreTestKit
  module USQualityCoreV100
    class ProcedureGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the capabilities required by the US Quality Core Procedure.'
...
conforming to the US Quality Core Procedure as specified in the US Quality Core Implementation Guide.
...
read succeeds.
      ...
      id :us_quality_core_v100_procedure
      ...
      test from: :us_quality_core_v100_procedure_patient_status_search_test
      test from: :us_quality_core_v100_procedure_patient_search_test
      test from: :us_quality_core_v100_procedure_patient_date_search_test
      test from: :us_quality_core_v100_procedure_read_test
      test from: :us_quality_core_v100_procedure_provenance_revinclude_search_test
      test from: :us_quality_core_v100_procedure_validation_test
      test from: :us_quality_core_v100_procedure_must_support_test
      test from: :us_quality_core_v100_procedure_reference_resolution_test
    end
  end
end
