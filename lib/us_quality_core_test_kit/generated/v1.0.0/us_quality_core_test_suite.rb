...
module USQualityCoreTestKit
  module USCoreV100
    class USQualityCoreTestSuite < Inferno::TestSuite
      title 'US Quality Core Server v1.0.0'
      ...
      id :us_quality_core_v100

      fhir_resource_validator do
        igs 'fhir.onc.us-quality-core#1.0.0'
      ...
      group do
        ...
        id :us_quality_core_v100_fhir_api
        ...
        group from: :us_quality_core_v100_patient
        group from: :us_quality_core_v100_adverse_event
        group from: :us_quality_core_v100_allergy_intolerance
        group from: :us_quality_core_v100_care_plan
        group from: :us_quality_core_v100_care_team
        group from: :us_quality_core_v100_communication
        group from: :us_quality_core_v100_communicationdone
        group from: :us_quality_core_v100_communicationnotdone
        group from: :us_quality_core_v100_condition_encounter_diagnosis
        group from: :us_quality_core_v100_condition_problems_health_concerns
        group from: :us_quality_core_v100_coverage
        group from: :us_quality_core_v100_device
        group from: :us_quality_core_v100_devicerequest
        group from: :us_quality_core_v100_devicerequested
        group from: :us_quality_core_v100_deviceprohibited
        group from: :us_quality_core_v100_diagnostic_report_note
        group from: :us_quality_core_v100_diagnostic_report_lab
        group from: :us_quality_core_v100_document_reference
        group from: :us_quality_core_v100_family_member_history
        group from: :us_quality_core_v100_goal
        group from: :us_quality_core_v100_imaging_study
        group from: :us_quality_core_v100_immunization
        group from: :us_quality_core_v100_immunizationnotdone
        group from: :us_quality_core_v100_immunizationdone
        group from: :us_quality_core_v100_medicationadministration
        group from: :us_quality_core_v100_medicationadministrationnotdone
        group from: :us_quality_core_v100_medicationadministrationdone
        group from: :us_quality_core_v100_medicationdispense
        group from: :us_quality_core_v100_medicationdispensedeclined
        group from: :us_quality_core_v100_medicationdispensedone
        group from: :us_quality_core_v100_medicationrequest
        group from: :us_quality_core_v100_medicationprohibited
        group from: :us_quality_core_v100_medicationrequested
        group from: :us_quality_core_v100_nutrition_order
        group from: :us_quality_core_v100_observation_clinical_result
        group from: :us_quality_core_v100_us_core_observation_adi_documentation
        group from: :us_quality_core_v100_us_core_treatment_intervention_preference
        group from: :us_quality_core_v100_simple_observation
        group from: :us_quality_core_v100_observation_screening_assessment
        group from: :us_quality_core_v100_us_core_observation_pregnancystatus
        group from: :us_quality_core_v100_us_core_observation_pregnancyintent
        group from: :us_quality_core_v100_us_core_smokingstatus
        group from: :us_quality_core_v100_observation_lab
        group from: :us_quality_core_v100_us_core_observation_occupation
        group from: :us_quality_core_v100_us_core_blood_pressure
        group from: :us_quality_core_v100_us_core_bmi
        group from: :us_quality_core_v100_pediatric_bmi_for_age
        group from: :us_quality_core_v100_us_core_body_height
        group from: :us_quality_core_v100_us_core_body_temperature
        group from: :us_quality_core_v100_us_core_body_weight
        group from: :us_quality_core_v100_head_occipital_frontal_circumference_percentile
        group from: :us_quality_core_v100_us_core_heart_rate
        group from: :us_quality_core_v100_us_core_pulse_oximetry
        group from: :us_quality_core_v100_us_core_respiratory_rate
        group from: :us_quality_core_v100_pediatric_weight_for_height
        group from: :us_quality_core_v100_procedure
        group from: :us_quality_core_v100_procedurenotdone
        group from: :us_quality_core_v100_proceduredone
        group from: :us_quality_core_v100_questionnaire_response
        group from: :us_quality_core_v100_related_person
        group from: :us_quality_core_v100_servicerequest
        group from: :us_quality_core_v100_serviceprohibited
        group from: :us_quality_core_v100_servicerequested
        group from: :us_quality_core_v100_task
        group from: :us_quality_core_v100_taskrejected
        group from: :us_quality_core_v100_taskdone
        group from: :us_quality_core_v100_encounter
        group from: :us_quality_core_v100_location
        group from: :us_quality_core_v100_organization
        group from: :us_quality_core_v100_practitioner
        group from: :us_quality_core_v100_practitioner_role
        group from: :us_quality_core_v100_provenance
        group from: :us_quality_core_v100_specimen
      end
