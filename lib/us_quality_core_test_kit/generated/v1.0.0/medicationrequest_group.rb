...
the [US Quality Core MedicationRequest Profile](http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-medicationrequest). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v100_medicationrequest
      ...
      test from: :us_quality_core_v100_medicationrequest_patient_intent_do_not_perform_search_test
      test from: :us_quality_core_v100_medicationrequest_patient_intent_search_test
      test from: :us_quality_core_v100_medicationrequest_read_test
      test from: :us_quality_core_v100_medicationrequest_provenance_revinclude_search_test
      test from: :us_quality_core_v100_medicationrequest_validation_test
      test from: :us_quality_core_v100_medicationrequest_must_support_test
      test from: :us_quality_core_v100_medicationrequest_reference_resolution_test
    end
  end
end
