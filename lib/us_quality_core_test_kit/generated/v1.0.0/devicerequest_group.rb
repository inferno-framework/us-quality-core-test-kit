...
the [US Quality Core DeviceRequest Profile](http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-devicerequest). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v100_devicerequest
      ...
      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'devicerequest', 'metadata.yml'), aliases: true))
      end

  
      test from: :us_quality_core_v100_devicerequest_patient_do_not_perform_search_test
      test from: :us_quality_core_v100_devicerequest_patient_search_test
      test from: :us_quality_core_v100_devicerequest_patient_code_search_test
      test from: :us_quality_core_v100_devicerequest_read_test
      test from: :us_quality_core_v100_devicerequest_provenance_revinclude_search_test
      test from: :us_quality_core_v100_devicerequest_validation_test
      test from: :us_quality_core_v100_devicerequest_must_support_test
    end
  end
end
