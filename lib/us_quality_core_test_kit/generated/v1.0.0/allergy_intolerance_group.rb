...
read succeeds.
      ...
      id :us_quality_core_v100_allergy_intolerance
      ...
      test from: :us_quality_core_v100_allergy_intolerance_patient_search_test
      test from: :us_quality_core_v100_allergy_intolerance_read_test
      test from: :us_quality_core_v100_allergy_intolerance_provenance_revinclude_search_test
      test from: :us_quality_core_v100_allergy_intolerance_validation_test
      test from: :us_quality_core_v100_allergy_intolerance_must_support_test
      test from: :us_quality_core_v100_allergy_intolerance_reference_resolution_test
    end
  end
end
