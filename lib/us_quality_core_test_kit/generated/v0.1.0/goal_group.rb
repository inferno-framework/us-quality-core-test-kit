...
the [US Quality Core Goal Profile](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-goal). Each element is checked against
...
read succeeds.
      ...
      test from: :us_quality_core_v010_goal_patient_search_test
      test from: :us_quality_core_v010_goal_read_test
      test from: :us_quality_core_v010_goal_validation_test
      test from: :us_quality_core_v010_goal_must_support_test
      test from: :us_quality_core_v010_goal_reference_resolution_test
    end
  end
end
