...
the [US Quality Core Observation Cancelled Profile](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-observationcancelled). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v010_observationcancelled
      ...
      test from: :us_quality_core_v010_observationcancelled_validation_test
      test from: :us_quality_core_v010_observationcancelled_must_support_test
    end
  end
end
