...
the [US Quality Core AllergyIntolerance Profile](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-allergyintolerance). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v010_allergy_intolerance
      ...
      test from: :us_quality_core_v010_allergy_intolerance_patient_search_test
      test from: :us_quality_core_v010_allergy_intolerance_read_test
      test from: :us_quality_core_v010_allergy_intolerance_validation_test
      test from: :us_quality_core_v010_allergy_intolerance_must_support_test
      test from: :us_quality_core_v010_allergy_intolerance_reference_resolution_test
    end
  end
end
