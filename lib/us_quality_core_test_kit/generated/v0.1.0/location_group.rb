...
the [US Quality Core Location Profile](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-location). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v010_location
      ...
      test from: :us_quality_core_v010_location_read_test
      test from: :us_quality_core_v010_location__id_search_test
      test from: :us_quality_core_v010_location_validation_test
      test from: :us_quality_core_v010_location_must_support_test
      test from: :us_quality_core_v010_location_reference_resolution_test
    end
  end
end
