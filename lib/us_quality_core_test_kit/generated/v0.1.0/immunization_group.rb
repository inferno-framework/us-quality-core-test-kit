...
the [US Quality Core Immunization Profile](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-immunization). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v010_immunization
      ...
      test from: :us_quality_core_v010_immunization_patient_status_search_test
      test from: :us_quality_core_v010_immunization_patient_search_test
      test from: :us_quality_core_v010_immunization_patient_date_search_test
      test from: :us_quality_core_v010_immunization_read_test
      test from: :us_quality_core_v010_immunization_validation_test
      test from: :us_quality_core_v010_immunization_must_support_test
      test from: :us_quality_core_v010_immunization_reference_resolution_test
    end
  end
end
