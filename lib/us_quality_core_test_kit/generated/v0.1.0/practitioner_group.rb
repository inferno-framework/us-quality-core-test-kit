...
module USQualityCoreTestKit
  module USQualityCoreV010
    class PractitionerGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the capabilities required by the US Quality Core Practitioner.'
...
conforming to the US Quality Core Practitioner as specified in the US Quality Core Implementation Guide.
...
the [US Quality Core Practitioner Profile](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-practitioner). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v010_practitioner
      ...
      test from: :us_quality_core_v010_practitioner_read_test
      test from: :us_quality_core_v010_practitioner__id_search_test
      test from: :us_quality_core_v010_practitioner_validation_test
      test from: :us_quality_core_v010_practitioner_must_support_test
    end
  end
end
