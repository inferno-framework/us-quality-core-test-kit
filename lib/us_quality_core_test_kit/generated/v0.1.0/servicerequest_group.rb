...
the [US Quality Core ServiceRequest Profile](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-servicerequest). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v010_servicerequest
      ...
      test from: :us_quality_core_v010_servicerequest_reference_resolution_test
    end
  end
end
