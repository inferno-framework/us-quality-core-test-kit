...
the [US Quality Core Observation Screening Assessment Profile](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-observation-screening-assessment). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v010_observation_screening_assessment
      ...
      test from: :us_quality_core_v010_observation_screening_assessment_validation_test
      test from: :us_quality_core_v010_observation_screening_assessment_must_support_test
      test from: :us_quality_core_v010_observation_screening_assessment_reference_resolution_test
    end
  end
end
