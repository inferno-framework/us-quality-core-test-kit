...
module USQualityCoreTestKit
  module USQualityCoreV010
    class PractitionerRoleGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the capabilities required by the US Quality Core PractitionerRole.'

      description %(
  # Background

These tests verify that the system under test is able to provide correct
responses for PractitionerRole queries. These queries must contain resources
conforming to the US Quality Core PractitionerRole as specified in the US Quality Core Implementation Guide.
...
fail. The test will look through the PractitionerRole resources found
in the first test for these elements.

## Profile Validation
Each resource returned from the first search is expected to conform to
the [US Quality Core PractitionerRole Profile](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-practitionerrole). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v010_practitioner_role
      ...
      test from: :us_quality_core_v010_practitioner_role_read_test
      test from: :us_quality_core_v010_practitioner_role__id_search_test
      test from: :us_quality_core_v010_practitioner_role_validation_test
      test from: :us_quality_core_v010_practitioner_role_must_support_test
      test from: :us_quality_core_v010_practitioner_role_reference_resolution_test
    end
  end
end
