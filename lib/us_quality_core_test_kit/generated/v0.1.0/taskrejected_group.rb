require_relative 'taskrejected/taskrejected_patient_status_search_test'
...
the [US Quality Core Task Rejected Profile](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-taskrejected). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v010_taskrejected
      ...
      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'taskrejected', 'metadata.yml'), aliases: true))
      end

  
      test from: :us_quality_core_v010_taskrejected_patient_status_search_test
      test from: :us_quality_core_v010_taskrejected_patient_search_test
      test from: :us_quality_core_v010_taskrejected_patient_code_search_test
      test from: :us_quality_core_v010_taskrejected_read_test
      test from: :us_quality_core_v010_taskrejected_validation_test
      test from: :us_quality_core_v010_taskrejected_must_support_test
      test from: :us_quality_core_v010_taskrejected_reference_resolution_test
    end
  end
end
