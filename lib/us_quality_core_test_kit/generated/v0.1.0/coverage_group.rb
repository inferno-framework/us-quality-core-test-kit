...
the [US Quality Core Coverage Profile](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-coverage). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v010_coverage
      ...
      test from: :us_quality_core_v010_coverage_patient_search_test
      test from: :us_quality_core_v010_coverage_read_test
      test from: :us_quality_core_v010_coverage_validation_test
      test from: :us_quality_core_v010_coverage_must_support_test
      test from: :us_quality_core_v010_coverage_reference_resolution_test
    end
  end
end
