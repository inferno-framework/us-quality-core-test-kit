...
the [US Quality Core FamilyMemberHistory Profile](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-familymemberhistory). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v010_family_member_history
      ...
      test from: :us_quality_core_v010_family_member_history_patient_search_test
      test from: :us_quality_core_v010_family_member_history_read_test
      test from: :us_quality_core_v010_family_member_history_validation_test
      test from: :us_quality_core_v010_family_member_history_must_support_test
    end
  end
end
