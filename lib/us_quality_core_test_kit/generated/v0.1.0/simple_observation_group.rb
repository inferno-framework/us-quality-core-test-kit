...
the [US Quality Core Simple Observation Profile](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-simple-observation). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v010_simple_observation
      ...
      test from: :us_quality_core_v010_simple_observation_validation_test
      test from: :us_quality_core_v010_simple_observation_must_support_test
      test from: :us_quality_core_v010_simple_observation_reference_resolution_test
    end
  end
end
