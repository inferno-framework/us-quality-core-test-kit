...
the [US Quality Core CareTeam Profile](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-careteam). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v010_care_team
      ...
      test from: :us_quality_core_v010_care_team_patient_status_search_test
      test from: :us_quality_core_v010_care_team_read_test
      test from: :us_quality_core_v010_care_team_validation_test
      test from: :us_quality_core_v010_care_team_must_support_test
      test from: :us_quality_core_v010_care_team_reference_resolution_test
    end
  end
end
