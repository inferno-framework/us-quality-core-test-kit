...
the [US Quality Core Device Not Requested](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-devicenotrequested).
...
fail if their code/system are not found in the valueset.
      ...
      run do
        perform_validation_test(scratch_resources[:all] || [],
                                'http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-devicenotrequested',
                                '0.1.0',
                                skip_if_empty: true)
      end
    end
