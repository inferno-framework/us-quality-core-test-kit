...
the [US Quality Core DeviceRequest Profile](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-devicerequest). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v010_devicerequest
      ...
      test from: :us_quality_core_v010_devicerequest_reference_resolution_test
    end
  end
end
