...
the [US Quality Core DiagnosticReport Profile for Laboratory Results Reporting Profile](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-diagnosticreport-lab). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v010_diagnostic_report_lab
      ...
      test from: :us_quality_core_v010_diagnostic_report_lab_patient_category_search_test
      test from: :us_quality_core_v010_diagnostic_report_lab_patient_search_test
      test from: :us_quality_core_v010_diagnostic_report_lab_patient_category_date_search_test
      test from: :us_quality_core_v010_diagnostic_report_lab_patient_code_search_test
      test from: :us_quality_core_v010_diagnostic_report_lab_read_test
      test from: :us_quality_core_v010_diagnostic_report_lab_validation_test
      test from: :us_quality_core_v010_diagnostic_report_lab_must_support_test
      test from: :us_quality_core_v010_diagnostic_report_lab_reference_resolution_test
    end
  end
end
