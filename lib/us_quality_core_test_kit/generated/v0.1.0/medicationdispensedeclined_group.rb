...
the [US Quality Core MedicationDispense Declined Profile](http://fhir.org/guides/astp/us-quality-core/StructureDefinition/us-quality-core-medicationdispensedeclined). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v010_medicationdispensedeclined
      ...
      test from: :us_quality_core_v010_medicationdispensedeclined_patient_status_search_test
      test from: :us_quality_core_v010_medicationdispensedeclined_patient_search_test
      test from: :us_quality_core_v010_medicationdispensedeclined_read_test
      test from: :us_quality_core_v010_medicationdispensedeclined_validation_test
      test from: :us_quality_core_v010_medicationdispensedeclined_must_support_test
      test from: :us_quality_core_v010_medicationdispensedeclined_reference_resolution_test
    end
  end
end
