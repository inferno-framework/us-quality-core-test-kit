...
module USQualityCoreTestKit
  module USQualityCoreV050
    class ImagingStudyProvenanceRevincludeSearchTest < Inferno::Test
      ...
      title 'Server returns Provenance resources from ImagingStudy search by patient + revInclude:Provenance:target'
      description %(
      ...
      id :us_quality_core_v050_imaging_study_provenance_revinclude_search_test
