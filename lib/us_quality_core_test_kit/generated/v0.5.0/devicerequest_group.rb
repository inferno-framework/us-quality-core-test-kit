...
the [US Quality Core DeviceRequest Profile](http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-devicerequest). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v050_devicerequest
      ...
      test from: :us_quality_core_v050_devicerequest_patient_do_not_perform_search_test
