...
the [US Quality Core Observation Cancelled Profile](http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-observationcancelled). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v050_observationcancelled
      ...
      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'observationcancelled', 'metadata.yml'), aliases: true))
      end

  
      test from: :us_quality_core_v050_observationcancelled_patient_category_status_search_test
      test from: :us_quality_core_v050_observationcancelled_patient_category_search_test
