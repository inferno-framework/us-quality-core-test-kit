...
module USQualityCoreTestKit
  module USCoreV050
    class UsQualityCoreObservationcancelledProvenanceRevincludeSearchTest < Inferno::Test
      ...
      id :us_core_v050_us_quality_core_observationcancelled_provenance_revinclude_search_test
      ...
      def scratch_resources
        scratch[:us_quality_core_observationcancelled_resources] ||= {}
      end
