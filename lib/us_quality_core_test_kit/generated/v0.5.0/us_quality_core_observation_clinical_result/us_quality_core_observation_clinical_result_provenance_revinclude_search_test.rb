...
module USQualityCoreTestKit
  module USCoreV050
    class UsQualityCoreObservationClinicalResultProvenanceRevincludeSearchTest < Inferno::Test
      ...
      id :us_core_v050_us_quality_core_observation_clinical_result_provenance_revinclude_search_test
      ...
      def scratch_resources
        scratch[:us_quality_core_observation_clinical_result_resources] ||= {}
      end
