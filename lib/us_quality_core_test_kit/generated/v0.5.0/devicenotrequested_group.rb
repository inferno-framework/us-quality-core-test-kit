...
module USQualityCoreTestKit
  module USQualityCoreV050
    class DevicenotrequestedGroup < Inferno::TestGroup
      title 'DeviceRequest Device Not Requested Tests'

      short_description 'Verify support for the capabilities required by the US Quality Core Device Not Requested Profile.'
...
conforming to the US Quality Core Device Not Requested Profile as specified in the US Quality Core Implementation Guide.
...
the [US Quality Core Device Not Requested Profile](http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-devicenotrequested). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v050_devicenotrequested
      ...
      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'devicenotrequested', 'metadata.yml'), aliases: true))
      end

  
      test from: :us_quality_core_v050_devicenotrequested_patient_do_not_perform_search_test
