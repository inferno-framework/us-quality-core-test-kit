...
module USQualityCoreTestKit
  module USQualityCoreV050
    class DevicenotrequestedGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the capabilities required by the US Quality Core Device Not Requested.'
...
conforming to the US Quality Core Device Not Requested as specified in the US Quality Core Implementation Guide.
