...
module USQualityCoreTestKit
  module USQualityCoreV050
    class ObservationLabGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the capabilities required by the US Quality Core Laboratory Result Observation.'
...
conforming to the US Quality Core Laboratory Result Observation as specified in the US Quality Core Implementation Guide.
