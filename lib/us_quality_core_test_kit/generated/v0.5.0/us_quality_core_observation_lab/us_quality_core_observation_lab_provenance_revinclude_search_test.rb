...
module USQualityCoreTestKit
  module USCoreV050
    class UsQualityCoreObservationLabProvenanceRevincludeSearchTest < Inferno::Test
      ...
      id :us_core_v050_us_quality_core_observation_lab_provenance_revinclude_search_test
      ...
      def scratch_resources
        scratch[:us_quality_core_observation_lab_resources] ||= {}
      end
