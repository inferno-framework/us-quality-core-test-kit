...
module USQualityCoreTestKit
  module USCoreV050
    class UsQualityCoreDiagnosticReportLabProvenanceRevincludeSearchTest < Inferno::Test
      ...
      id :us_core_v050_us_quality_core_diagnostic_report_lab_provenance_revinclude_search_test
      ...
      def scratch_resources
        scratch[:us_quality_core_diagnostic_report_lab_resources] ||= {}
      end
