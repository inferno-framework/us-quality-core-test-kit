...
the [US Quality Core AdverseEvent Profile](http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-adverseevent). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v050_adverse_event
      ...
      test from: :us_quality_core_v050_adverse_event_subject_search_test
