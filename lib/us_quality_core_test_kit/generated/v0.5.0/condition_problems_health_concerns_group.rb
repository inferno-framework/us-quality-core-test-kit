...
read succeeds.
      ...
      id :us_quality_core_v050_condition_problems_health_concerns
      ...
      test from: :us_quality_core_v050_condition_problems_health_concerns_patient_category_search_test
      test from: :us_quality_core_v050_condition_problems_health_concerns_patient_search_test
      test from: :us_quality_core_v050_condition_problems_health_concerns_patient_code_search_test
      test from: :us_quality_core_v050_condition_problems_health_concerns_read_test
      test from: :us_quality_core_v050_condition_problems_health_concerns_provenance_revinclude_search_test
      test from: :us_quality_core_v050_condition_problems_health_concerns_validation_test
      test from: :us_quality_core_v050_condition_problems_health_concerns_must_support_test
      test from: :us_quality_core_v050_condition_problems_health_concerns_reference_resolution_test
    end
  end
end
