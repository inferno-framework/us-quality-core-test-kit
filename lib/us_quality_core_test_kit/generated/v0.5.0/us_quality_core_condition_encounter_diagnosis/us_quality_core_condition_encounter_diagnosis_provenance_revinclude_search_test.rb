...
module USQualityCoreTestKit
  module USCoreV050
    class UsQualityCoreConditionEncounterDiagnosisProvenanceRevincludeSearchTest < Inferno::Test
      ...
      id :us_core_v050_us_quality_core_condition_encounter_diagnosis_provenance_revinclude_search_test
      ...
      def scratch_resources
        scratch[:us_quality_core_condition_encounter_diagnosis_resources] ||= {}
      end
