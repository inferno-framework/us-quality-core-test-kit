...
module USQualityCoreTestKit
  module USCoreV050
    class UsQualityCoreSimpleObservationProvenanceRevincludeSearchTest < Inferno::Test
      ...
      id :us_core_v050_us_quality_core_simple_observation_provenance_revinclude_search_test
      ...
      def scratch_resources
        scratch[:us_quality_core_simple_observation_resources] ||= {}
      end
