...
module USQualityCoreTestKit
  module USQualityCoreV050
    class PatientValidationTest < Inferno::Test
      ...
      id :us_quality_core_v050_patient_validation_test

      title 'Patient resources returned during previous tests conform to the US Quality Core Patient Profile'

      description %(
This test verifies resources returned from the first search conform to
the [US Quality Core Patient Profile](http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-patient).
