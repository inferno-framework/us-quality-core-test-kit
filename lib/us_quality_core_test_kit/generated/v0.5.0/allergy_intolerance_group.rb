...
module USQualityCoreTestKit
  module USQualityCoreV050
    class AllergyIntoleranceGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the capabilities required by the US Quality Core AllergyIntolerance.'
...
conforming to the US Quality Core AllergyIntolerance as specified in the US Quality Core Implementation Guide.
