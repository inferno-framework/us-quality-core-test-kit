...
module USQualityCoreTestKit
  module USCoreV050
    class UsQualityCoreDiagnosticReportNoteProvenanceRevincludeSearchTest < Inferno::Test
      ...
      id :us_core_v050_us_quality_core_diagnostic_report_note_provenance_revinclude_search_test
      ...
      def scratch_resources
        scratch[:us_quality_core_diagnostic_report_note_resources] ||= {}
      end
