...
the [US Quality Core Service Not Requested Profile](http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-servicenotrequested). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v050_servicenotrequested
      ...
      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'servicenotrequested', 'metadata.yml'), aliases: true))
      end

  
      test from: :us_quality_core_v050_servicenotrequested_patient_do_not_perform_search_test
      test from: :us_quality_core_v050_servicenotrequested__id_search_test
      test from: :us_quality_core_v050_servicenotrequested_patient_search_test
      test from: :us_quality_core_v050_servicenotrequested_patient_category_search_test
