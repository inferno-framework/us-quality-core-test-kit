...
module USQualityCoreTestKit
  module USCoreV050
    class UsQualityCoreConditionProblemsHealthConcernsProvenanceRevincludeSearchTest < Inferno::Test
      ...
      id :us_core_v050_us_quality_core_condition_problems_health_concerns_provenance_revinclude_search_test
      ...
      def scratch_resources
        scratch[:us_quality_core_condition_problems_health_concerns_resources] ||= {}
      end
