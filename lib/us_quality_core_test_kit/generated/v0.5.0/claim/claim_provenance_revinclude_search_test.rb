...
module USQualityCoreTestKit
  module USQualityCoreV050
    class ClaimProvenanceRevincludeSearchTest < Inferno::Test
      include USQualityCoreTestKit::SearchTest

      title 'Server returns Provenance resources from Claim search by patient + revInclude:Provenance:target'
      description %(
      ...
      id :us_quality_core_v050_claim_provenance_revinclude_search_test
