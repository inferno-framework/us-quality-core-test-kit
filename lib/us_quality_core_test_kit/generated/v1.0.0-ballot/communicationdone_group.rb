...
require_relative 'communicationdone/communicationdone_reference_resolution_test'
...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class CommunicationdoneGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the capabilities required by the US Quality Core CommunicationDone Profile.'
...
conforming to the US Quality Core CommunicationDone Profile as specified in the US Quality Core Implementation Guide.
...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_communicationdone
      ...
      test from: :us_quality_core_v100_ballot_communicationdone_must_support_test
      test from: :us_quality_core_v100_ballot_communicationdone_reference_resolution_test
    end
  end
end
