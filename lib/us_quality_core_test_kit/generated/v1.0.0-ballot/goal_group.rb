...
fail. The test will look through the Goal resources found
in the first test for these elements.

## Profile Validation
Each resource returned from the first search is expected to conform to
the [US Quality Core Goal Profile](http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-goal). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_goal
      ...
      test from: :us_quality_core_v100_ballot_goal_patient_search_test
      test from: :us_quality_core_v100_ballot_goal_read_test
      test from: :us_quality_core_v100_ballot_goal_provenance_revinclude_search_test
      test from: :us_quality_core_v100_ballot_goal_validation_test
      test from: :us_quality_core_v100_ballot_goal_must_support_test
      test from: :us_quality_core_v100_ballot_goal_reference_resolution_test
    end
  end
end
