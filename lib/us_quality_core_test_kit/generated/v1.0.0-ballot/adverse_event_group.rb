...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class AdverseEventGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the capabilities required by the US Quality Core AdverseEvent Profile.'
...
conforming to the US Quality Core AdverseEvent Profile as specified in the US Quality Core Implementation Guide.
...
the [US Quality Core AdverseEvent Profile](http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-adverseevent). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_adverse_event
      ...
      test from: :us_quality_core_v100_ballot_adverse_event_subject_search_test
      test from: :us_quality_core_v100_ballot_adverse_event_subject_event_search_test
      test from: :us_quality_core_v100_ballot_adverse_event_subject_recorded_date_search_test
      test from: :us_quality_core_v100_ballot_adverse_event_read_test
      test from: :us_quality_core_v100_ballot_adverse_event_provenance_revinclude_search_test
      test from: :us_quality_core_v100_ballot_adverse_event_validation_test
      test from: :us_quality_core_v100_ballot_adverse_event_must_support_test
      test from: :us_quality_core_v100_ballot_adverse_event_reference_resolution_test
    end
  end
end
