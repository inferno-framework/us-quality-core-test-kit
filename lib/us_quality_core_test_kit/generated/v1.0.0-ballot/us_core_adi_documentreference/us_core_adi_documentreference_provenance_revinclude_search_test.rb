...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class UsCoreAdiDocumentreferenceProvenanceRevincludeSearchTest < Inferno::Test
      ...
      id :us_quality_core_v100_ballot_us_core_adi_documentreference_provenance_revinclude_search_test
