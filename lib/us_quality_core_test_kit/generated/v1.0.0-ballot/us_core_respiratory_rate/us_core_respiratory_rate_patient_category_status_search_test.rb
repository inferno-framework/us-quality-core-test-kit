...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class UsCoreRespiratoryRatePatientCategoryStatusSearchTest < Inferno::Test
...
none are returned, the test is skipped.
      ...
      id :us_quality_core_v100_ballot_us_core_respiratory_rate_patient_category_status_search_test
      ...
      def scratch_resources
        scratch[:us_core_respiratory_rate_resources] ||= {}
      end
