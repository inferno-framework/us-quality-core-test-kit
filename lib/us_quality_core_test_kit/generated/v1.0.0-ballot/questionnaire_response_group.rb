...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class QuestionnaireResponseGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the capabilities required by the US Quality Core QuestionnaireResponse Profile.'

      description %(
  # Background

These tests verify that the system under test is able to provide correct
responses for QuestionnaireResponse queries. These queries must contain resources
conforming to the US Quality Core QuestionnaireResponse Profile as specified in the US Quality Core Implementation Guide.
...
fail. The test will look through the QuestionnaireResponse resources found
in the first test for these elements.

## Profile Validation
Each resource returned from the first search is expected to conform to
the [US Quality Core QuestionnaireResponse Profile](http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-questionnaireresponse). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_questionnaire_response
      ...
      test from: :us_quality_core_v100_ballot_questionnaire_response_patient_search_test
      test from: :us_quality_core_v100_ballot_questionnaire_response_patient_questionnaire_search_test
      test from: :us_quality_core_v100_ballot_questionnaire_response_read_test
      test from: :us_quality_core_v100_ballot_questionnaire_response_provenance_revinclude_search_test
      test from: :us_quality_core_v100_ballot_questionnaire_response_validation_test
      test from: :us_quality_core_v100_ballot_questionnaire_response_must_support_test
      test from: :us_quality_core_v100_ballot_questionnaire_response_reference_resolution_test
    end
  end
end
