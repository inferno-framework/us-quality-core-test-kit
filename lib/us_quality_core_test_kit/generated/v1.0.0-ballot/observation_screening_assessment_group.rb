...
the [US Quality Core Observation Screening Assessment Profile](http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-observation-screening-assessment). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_observation_screening_assessment
      ...
      test from: :us_quality_core_v100_ballot_observation_screening_assessment_patient_category_status_search_test
      test from: :us_quality_core_v100_ballot_observation_screening_assessment_patient_category_search_test
      test from: :us_quality_core_v100_ballot_observation_screening_assessment_patient_category_date_search_test
      test from: :us_quality_core_v100_ballot_observation_screening_assessment_patient_code_search_test
      test from: :us_quality_core_v100_ballot_observation_screening_assessment_read_test
      test from: :us_quality_core_v100_ballot_observation_screening_assessment_provenance_revinclude_search_test
      test from: :us_quality_core_v100_ballot_observation_screening_assessment_validation_test
      test from: :us_quality_core_v100_ballot_observation_screening_assessment_must_support_test
      test from: :us_quality_core_v100_ballot_observation_screening_assessment_reference_resolution_test
    end
  end
end
