...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class CommunicationnotdoneMustSupportTest < Inferno::Test
      ...
      description %(
        ...
        * Communication.extension:event-recorded
        * Communication.sent
      ...
      id :us_quality_core_v100_ballot_communicationnotdone_must_support_test
