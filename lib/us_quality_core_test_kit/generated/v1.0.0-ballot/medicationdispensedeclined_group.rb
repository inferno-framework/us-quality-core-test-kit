...
the [US Quality Core MedicationDispense Declined Profile](http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-medicationdispensedeclined). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_medicationdispensedeclined
      ...
      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'medicationdispensedeclined', 'metadata.yml'), aliases: true))
      end

  
      test from: :us_quality_core_v100_ballot_medicationdispensedeclined_patient_status_search_test
      test from: :us_quality_core_v100_ballot_medicationdispensedeclined_patient_search_test
      test from: :us_quality_core_v100_ballot_medicationdispensedeclined_read_test
      test from: :us_quality_core_v100_ballot_medicationdispensedeclined_provenance_revinclude_search_test
      test from: :us_quality_core_v100_ballot_medicationdispensedeclined_validation_test
      test from: :us_quality_core_v100_ballot_medicationdispensedeclined_must_support_test
      test from: :us_quality_core_v100_ballot_medicationdispensedeclined_reference_resolution_test
    end
  end
end
