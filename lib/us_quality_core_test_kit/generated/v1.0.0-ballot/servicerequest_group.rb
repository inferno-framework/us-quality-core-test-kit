...
require_relative 'servicerequest/servicerequest_provenance_revinclude_search_test'
...
require_relative 'servicerequest/servicerequest_reference_resolution_test'
...
the [US Quality Core ServiceRequest Profile](http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-servicerequest). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_servicerequest
      ...
      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'servicerequest', 'metadata.yml'), aliases: true))
      end

  
      test from: :us_quality_core_v100_ballot_servicerequest_patient_do_not_perform_search_test
      test from: :us_quality_core_v100_ballot_servicerequest__id_search_test
      test from: :us_quality_core_v100_ballot_servicerequest_patient_search_test
      test from: :us_quality_core_v100_ballot_servicerequest_patient_category_search_test
      test from: :us_quality_core_v100_ballot_servicerequest_patient_category_authored_search_test
      test from: :us_quality_core_v100_ballot_servicerequest_patient_code_search_test
      test from: :us_quality_core_v100_ballot_servicerequest_read_test
      test from: :us_quality_core_v100_ballot_servicerequest_provenance_revinclude_search_test
      test from: :us_quality_core_v100_ballot_servicerequest_validation_test
      test from: :us_quality_core_v100_ballot_servicerequest_must_support_test
      test from: :us_quality_core_v100_ballot_servicerequest_reference_resolution_test
    end
  end
end
