...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class ImmunizationGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the capabilities required by the US Quality Core Immunization Profile.'
...
conforming to the US Quality Core Immunization Profile as specified in the US Quality Core Implementation Guide.
...
the [US Quality Core Immunization Profile](http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-immunization). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_immunization
      ...
      test from: :us_quality_core_v100_ballot_immunization_patient_status_search_test
      test from: :us_quality_core_v100_ballot_immunization_patient_search_test
      test from: :us_quality_core_v100_ballot_immunization_read_test
      test from: :us_quality_core_v100_ballot_immunization_provenance_revinclude_search_test
      test from: :us_quality_core_v100_ballot_immunization_validation_test
      test from: :us_quality_core_v100_ballot_immunization_must_support_test
      test from: :us_quality_core_v100_ballot_immunization_reference_resolution_test
    end
  end
end
