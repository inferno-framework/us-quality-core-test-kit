...
the [US Quality Core Organization Profile](http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-organization). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_organization
      ...
      test from: :us_quality_core_v100_ballot_organization_read_test
      test from: :us_quality_core_v100_ballot_organization_validation_test
      test from: :us_quality_core_v100_ballot_organization_must_support_test
    end
  end
end
