...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_pediatric_bmi_for_age
      ...
      test from: :us_quality_core_v100_ballot_pediatric_bmi_for_age_patient_code_search_test
      test from: :us_quality_core_v100_ballot_pediatric_bmi_for_age_patient_category_status_search_test
      test from: :us_quality_core_v100_ballot_pediatric_bmi_for_age_patient_category_search_test
      test from: :us_quality_core_v100_ballot_pediatric_bmi_for_age_patient_category_date_search_test
      test from: :us_quality_core_v100_ballot_pediatric_bmi_for_age_read_test
      test from: :us_quality_core_v100_ballot_pediatric_bmi_for_age_provenance_revinclude_search_test
      test from: :us_quality_core_v100_ballot_pediatric_bmi_for_age_validation_test
      test from: :us_quality_core_v100_ballot_pediatric_bmi_for_age_must_support_test
      test from: :us_quality_core_v100_ballot_pediatric_bmi_for_age_reference_resolution_test
    end
  end
end
