...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class MedicationadministrationdonePatientCodeSearchTest < Inferno::Test
...
`_include=MedicationAdministration:medication`.
      ...
      id :us_quality_core_v100_ballot_medicationadministrationdone_patient_code_search_test
      input :patient_ids,
        title: 'Patient IDs',
