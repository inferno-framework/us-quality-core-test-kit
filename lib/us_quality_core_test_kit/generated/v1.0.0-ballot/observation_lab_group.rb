...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class ObservationLabGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the capabilities required by the US Quality Core Laboratory Result Observation Profile.'
...
conforming to the US Quality Core Laboratory Result Observation Profile as specified in the US Quality Core Implementation Guide.
...
the [US Quality Core Laboratory Result Observation Profile](http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-observation-lab). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_observation_lab
      ...
      test from: :us_quality_core_v100_ballot_observation_lab_patient_category_status_search_test
      test from: :us_quality_core_v100_ballot_observation_lab_patient_category_search_test
      test from: :us_quality_core_v100_ballot_observation_lab_patient_category_date_search_test
      test from: :us_quality_core_v100_ballot_observation_lab_patient_code_search_test
      test from: :us_quality_core_v100_ballot_observation_lab_read_test
      test from: :us_quality_core_v100_ballot_observation_lab_provenance_revinclude_search_test
      test from: :us_quality_core_v100_ballot_observation_lab_validation_test
      test from: :us_quality_core_v100_ballot_observation_lab_must_support_test
      test from: :us_quality_core_v100_ballot_observation_lab_reference_resolution_test
    end
  end
end
