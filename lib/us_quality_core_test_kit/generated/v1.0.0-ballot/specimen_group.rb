...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_specimen
      ...
      test from: :us_quality_core_v100_ballot_specimen_read_test
      test from: :us_quality_core_v100_ballot_specimen__id_search_test
      test from: :us_quality_core_v100_ballot_specimen_validation_test
      test from: :us_quality_core_v100_ballot_specimen_must_support_test
      test from: :us_quality_core_v100_ballot_specimen_reference_resolution_test
    end
  end
end
