...
fail. The test will look through the RelatedPerson resources found
in the first test for these elements.

## Profile Validation
Each resource returned from the first search is expected to conform to
the [US Quality Core RelatedPerson Profile](http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-relatedperson). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_related_person
      ...
      test from: :us_quality_core_v100_ballot_related_person_patient_search_test
      test from: :us_quality_core_v100_ballot_related_person__id_search_test
      test from: :us_quality_core_v100_ballot_related_person_read_test
      test from: :us_quality_core_v100_ballot_related_person_provenance_revinclude_search_test
      test from: :us_quality_core_v100_ballot_related_person_validation_test
      test from: :us_quality_core_v100_ballot_related_person_must_support_test
      test from: :us_quality_core_v100_ballot_related_person_reference_resolution_test
    end
  end
end
