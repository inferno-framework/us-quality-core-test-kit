...
fail. The test will look through the Coverage resources found
in the first test for these elements.

## Profile Validation
Each resource returned from the first search is expected to conform to
the [US Quality Core Coverage Profile](http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-coverage). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_coverage
      ...
      test from: :us_quality_core_v100_ballot_coverage_patient_search_test
      test from: :us_quality_core_v100_ballot_coverage_read_test
      test from: :us_quality_core_v100_ballot_coverage_provenance_revinclude_search_test
      test from: :us_quality_core_v100_ballot_coverage_validation_test
      test from: :us_quality_core_v100_ballot_coverage_must_support_test
      test from: :us_quality_core_v100_ballot_coverage_reference_resolution_test
    end
  end
end
