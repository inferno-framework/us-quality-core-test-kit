...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class UsCoreObservationAdiDocumentationProvenanceRevincludeSearchTest < Inferno::Test
      ...
      id :us_quality_core_v100_ballot_us_core_observation_adi_documentation_provenance_revinclude_search_test
