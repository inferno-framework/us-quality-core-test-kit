...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class HeadOccipitalFrontalCircumferencePercentileValidationTest < Inferno::Test
      include USQualityCoreTestKit::ValidationTest

      id :us_quality_core_v100_ballot_head_occipital_frontal_circumference_percentile_validation_test
