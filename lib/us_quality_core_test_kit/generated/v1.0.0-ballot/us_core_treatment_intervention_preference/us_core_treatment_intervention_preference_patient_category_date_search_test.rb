...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class UsCoreTreatmentInterventionPreferencePatientCategoryDateSearchTest < Inferno::Test
...
none are returned, the test is skipped.
      ...
      id :us_quality_core_v100_ballot_us_core_treatment_intervention_preference_patient_category_date_search_test
      input :patient_ids,
        title: 'Patient IDs',
