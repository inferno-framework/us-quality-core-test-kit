...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class UsCoreTreatmentInterventionPreferenceProvenanceRevincludeSearchTest < Inferno::Test
      ...
      id :us_quality_core_v100_ballot_us_core_treatment_intervention_preference_provenance_revinclude_search_test
