...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class UsCoreTreatmentInterventionPreferencePatientCodeSearchTest < Inferno::Test
...
FHIR R4 specification.
      ...
      id :us_quality_core_v100_ballot_us_core_treatment_intervention_preference_patient_code_search_test
      input :patient_ids,
        title: 'Patient IDs',
