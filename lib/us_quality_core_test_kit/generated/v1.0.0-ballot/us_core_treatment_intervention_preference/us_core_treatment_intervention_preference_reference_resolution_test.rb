...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class UsCoreTreatmentInterventionPreferenceReferenceResolutionTest < Inferno::Test
      ...
      id :us_quality_core_v100_ballot_us_core_treatment_intervention_preference_reference_resolution_test
