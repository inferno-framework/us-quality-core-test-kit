...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class UsCoreTreatmentInterventionPreferencePatientCategoryStatusSearchTest < Inferno::Test
...
none are returned, the test is skipped.
      ...
      id :us_quality_core_v100_ballot_us_core_treatment_intervention_preference_patient_category_status_search_test
      input :patient_ids,
        title: 'Patient IDs',
