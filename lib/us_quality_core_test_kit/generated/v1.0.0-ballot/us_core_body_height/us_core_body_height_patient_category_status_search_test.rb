...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class UsCoreBodyHeightPatientCategoryStatusSearchTest < Inferno::Test
...
none are returned, the test is skipped.
      ...
      id :us_quality_core_v100_ballot_us_core_body_height_patient_category_status_search_test
      input :patient_ids,
        title: 'Patient IDs',
      ...
      def scratch_resources
        scratch[:us_core_body_height_resources] ||= {}
      end
