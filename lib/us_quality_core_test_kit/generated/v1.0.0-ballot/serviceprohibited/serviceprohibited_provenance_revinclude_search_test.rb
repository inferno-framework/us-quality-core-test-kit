...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class ServiceprohibitedProvenanceRevincludeSearchTest < Inferno::Test
      include USQualityCoreTestKit::SearchTest

      title 'Server returns Provenance resources from ServiceRequest search by patient + do-not-perform + revInclude:Provenance:target'
      description %(
      ...
      id :us_quality_core_v100_ballot_serviceprohibited_provenance_revinclude_search_test
