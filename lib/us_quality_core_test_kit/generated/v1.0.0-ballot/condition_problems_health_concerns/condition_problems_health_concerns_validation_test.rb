...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class ConditionProblemsHealthConcernsValidationTest < Inferno::Test
      ...
      id :us_quality_core_v100_ballot_condition_problems_health_concerns_validation_test
...
the [US Quality Core Condition Problems Health Concerns Profile](http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-condition-problems-health-concerns).
