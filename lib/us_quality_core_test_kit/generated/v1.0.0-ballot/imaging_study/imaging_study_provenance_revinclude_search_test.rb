...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class ImagingStudyProvenanceRevincludeSearchTest < Inferno::Test
      include USQualityCoreTestKit::SearchTest

      title 'Server returns Provenance resources from ImagingStudy search by subject + revInclude:Provenance:target'
      description %(
      ...
      id :us_quality_core_v100_ballot_imaging_study_provenance_revinclude_search_test
