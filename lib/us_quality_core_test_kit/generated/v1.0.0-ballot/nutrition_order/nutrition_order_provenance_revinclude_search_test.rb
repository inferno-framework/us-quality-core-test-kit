...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class NutritionOrderProvenanceRevincludeSearchTest < Inferno::Test
      include USQualityCoreTestKit::SearchTest

      title 'Server returns Provenance resources from NutritionOrder search by patient + revInclude:Provenance:target'
      description %(
      ...
      id :us_quality_core_v100_ballot_nutrition_order_provenance_revinclude_search_test
