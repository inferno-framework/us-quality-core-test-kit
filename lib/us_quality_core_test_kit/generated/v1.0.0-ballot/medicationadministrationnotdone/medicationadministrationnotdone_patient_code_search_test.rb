...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class MedicationadministrationnotdonePatientCodeSearchTest < Inferno::Test
...
`_include=MedicationAdministration:medication`.
      ...
      id :us_quality_core_v100_ballot_medicationadministrationnotdone_patient_code_search_test
      input :patient_ids,
        title: 'Patient IDs',
