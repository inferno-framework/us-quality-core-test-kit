...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class MedicationadministrationnotdoneProvenanceRevincludeSearchTest < Inferno::Test
      include USQualityCoreTestKit::SearchTest

      title 'Server returns Provenance resources from MedicationAdministration search by patient + status + revInclude:Provenance:target'
      description %(
      ...
      id :us_quality_core_v100_ballot_medicationadministrationnotdone_provenance_revinclude_search_test
