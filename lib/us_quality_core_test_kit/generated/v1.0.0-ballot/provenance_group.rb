...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_provenance
      ...
      test from: :us_quality_core_v100_ballot_provenance_read_test
      test from: :us_quality_core_v100_ballot_provenance_validation_test
      test from: :us_quality_core_v100_ballot_provenance_must_support_test
      test from: :us_quality_core_v100_ballot_provenance_reference_resolution_test
    end
  end
end
