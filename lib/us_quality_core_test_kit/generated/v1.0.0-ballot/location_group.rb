...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_location
      ...
      test from: :us_quality_core_v100_ballot_location_read_test
      test from: :us_quality_core_v100_ballot_location_validation_test
      test from: :us_quality_core_v100_ballot_location_must_support_test
      test from: :us_quality_core_v100_ballot_location_reference_resolution_test
    end
  end
end
