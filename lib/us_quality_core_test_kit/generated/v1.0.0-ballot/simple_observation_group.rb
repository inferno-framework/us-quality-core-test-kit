...
the [US Quality Core Simple Observation Profile](http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-simple-observation). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_simple_observation
      ...
      test from: :us_quality_core_v100_ballot_simple_observation_patient_category_status_search_test
      test from: :us_quality_core_v100_ballot_simple_observation_patient_category_search_test
      test from: :us_quality_core_v100_ballot_simple_observation_patient_category_date_search_test
      test from: :us_quality_core_v100_ballot_simple_observation_patient_code_search_test
      test from: :us_quality_core_v100_ballot_simple_observation_read_test
      test from: :us_quality_core_v100_ballot_simple_observation_provenance_revinclude_search_test
      test from: :us_quality_core_v100_ballot_simple_observation_validation_test
      test from: :us_quality_core_v100_ballot_simple_observation_must_support_test
      test from: :us_quality_core_v100_ballot_simple_observation_reference_resolution_test
    end
  end
end
