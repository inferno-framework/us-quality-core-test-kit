...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class UsCoreObservationOccupationProvenanceRevincludeSearchTest < Inferno::Test
      ...
      id :us_quality_core_v100_ballot_us_core_observation_occupation_provenance_revinclude_search_test
