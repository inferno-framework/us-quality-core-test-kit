...
module USQualityCoreTestKit
  module USQualityCoreV100_BALLOT
    class DiagnosticReportNoteGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the capabilities required by the US Quality Core DiagnosticReport Profile for Report and Note Exchange Profile.'
...
conforming to the US Quality Core DiagnosticReport Profile for Report and Note Exchange Profile as specified in the US Quality Core Implementation Guide.
...
fail. The test will look through the DiagnosticReport resources found
in the first test for these elements.

## Profile Validation
Each resource returned from the first search is expected to conform to
the [US Quality Core DiagnosticReport Profile for Report and Note Exchange Profile](http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-diagnosticreport-note). Each element is checked against
...
read succeeds.
      ...
      id :us_quality_core_v100_ballot_diagnostic_report_note
      ...
      test from: :us_quality_core_v100_ballot_diagnostic_report_note_patient_category_search_test
      test from: :us_quality_core_v100_ballot_diagnostic_report_note_patient_search_test
      test from: :us_quality_core_v100_ballot_diagnostic_report_note_patient_category_date_search_test
      test from: :us_quality_core_v100_ballot_diagnostic_report_note_patient_code_search_test
      test from: :us_quality_core_v100_ballot_diagnostic_report_note_read_test
      test from: :us_quality_core_v100_ballot_diagnostic_report_note_provenance_revinclude_search_test
      test from: :us_quality_core_v100_ballot_diagnostic_report_note_validation_test
      test from: :us_quality_core_v100_ballot_diagnostic_report_note_must_support_test
      test from: :us_quality_core_v100_ballot_diagnostic_report_note_reference_resolution_test
    end
  end
end
