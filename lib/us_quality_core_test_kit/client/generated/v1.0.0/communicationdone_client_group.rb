  ...
  module Client
    module USQualityCoreClientV100
      class CommunicationdoneClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_communicationdone
...
conforming to the US Quality Core CommunicationDone.
...
do support it, they must support the US Quality Core CommunicationDone and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_communicationdone_client_read_test
        test from: :us_quality_core_v100_communicationdone_subject_client_search_test
        test from: :us_quality_core_v100_communicationdone_subject_topic_client_search_test
      end
    end
  end
end
