  ...
  module Client
    module USQualityCoreClientV100
      class MedicationrequestClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_medicationrequest
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_medicationrequest_client_read_test
        test from: :us_quality_core_v100_medicationrequest_patient_intent_do_not_perform_client_search_test
        test from: :us_quality_core_v100_medicationrequest_patient_intent_client_search_test
      end
    end
  end
end
