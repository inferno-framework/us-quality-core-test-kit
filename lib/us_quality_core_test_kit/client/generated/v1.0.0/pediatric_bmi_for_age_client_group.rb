  ...
  module Client
    module USQualityCoreClientV100
      class PediatricBmiForAgeClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_pediatric_bmi_for_age
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_pediatric_bmi_for_age_client_read_test
        test from: :us_quality_core_v100_pediatric_bmi_for_age_patient_code_client_search_test
        test from: :us_quality_core_v100_pediatric_bmi_for_age_patient_category_status_client_search_test
        test from: :us_quality_core_v100_pediatric_bmi_for_age_patient_category_client_search_test
        test from: :us_quality_core_v100_pediatric_bmi_for_age_patient_category_date_client_search_test
      end
    end
  end
end
