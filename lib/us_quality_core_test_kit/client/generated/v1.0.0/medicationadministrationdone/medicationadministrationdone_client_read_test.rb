  ...
  module Client
    module USQualityCoreClientV100
      class MedicationadministrationdoneClientReadTest < Inferno::Test
        ...
        id :us_quality_core_v100_medicationadministrationdone_client_read_test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core MedicationAdministration Done: `MedicationAdministration/usqualitycore-medicationadministrationdone`."
        end
        ...
        run do
          ...
          requests_for_id = filter_requests_by_resource_id(requests, 'usqualitycore-medicationadministrationdone')
