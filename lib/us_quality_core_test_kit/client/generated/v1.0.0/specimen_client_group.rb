  ...
  module Client
    module USQualityCoreClientV100
      class SpecimenClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_specimen
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_specimen_client_read_test
        test from: :us_quality_core_v100_specimen_id_client_search_test
      end
    end
  end
end
