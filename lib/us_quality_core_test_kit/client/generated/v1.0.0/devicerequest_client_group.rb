  ...
  module Client
    module USQualityCoreClientV100
      class DevicerequestClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_devicerequest
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_devicerequest_client_read_test
        test from: :us_quality_core_v100_devicerequest_patient_do_not_perform_client_search_test
        test from: :us_quality_core_v100_devicerequest_patient_client_search_test
        test from: :us_quality_core_v100_devicerequest_patient_code_client_search_test
      end
    end
  end
end
