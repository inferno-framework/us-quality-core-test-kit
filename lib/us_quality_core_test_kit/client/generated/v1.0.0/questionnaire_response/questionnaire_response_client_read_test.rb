  ...
  module Client
    module USQualityCoreClientV100
      class QuestionnaireResponseClientReadTest < Inferno::Test
        ...
        id :us_quality_core_v100_questionnaire_response_client_read_test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core QuestionnaireResponse: `QuestionnaireResponse/usqualitycore-questionnaire-response`."
        end
