  ...
  module Client
    module USQualityCoreClientV100
      class ServicerequestClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_servicerequest
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_servicerequest_client_read_test
        test from: :us_quality_core_v100_servicerequest_patient_do_not_perform_client_search_test
        test from: :us_quality_core_v100_servicerequest_id_client_search_test
        test from: :us_quality_core_v100_servicerequest_patient_client_search_test
        test from: :us_quality_core_v100_servicerequest_patient_category_client_search_test
        test from: :us_quality_core_v100_servicerequest_patient_category_authored_client_search_test
        test from: :us_quality_core_v100_servicerequest_patient_code_client_search_test
      end
    end
  end
end
