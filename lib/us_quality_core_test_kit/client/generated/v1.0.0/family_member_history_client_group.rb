  ...
  module Client
    module USQualityCoreClientV100
      class FamilyMemberHistoryClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_family_member_history
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_family_member_history_client_read_test
        test from: :us_quality_core_v100_family_member_history_patient_client_search_test
      end
    end
  end
end
