  ...
  module Client
    module USQualityCoreClientV100
      class DocumentReferenceClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_document_reference
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_document_reference_client_read_test
        test from: :us_quality_core_v100_document_reference_patient_client_search_test
        test from: :us_quality_core_v100_document_reference_id_client_search_test
        test from: :us_quality_core_v100_document_reference_patient_type_client_search_test
        test from: :us_quality_core_v100_document_reference_patient_category_client_search_test
        test from: :us_quality_core_v100_document_reference_patient_category_date_client_search_test
      end
    end
  end
end
