  ...
  module Client
    module USQualityCoreClientV100
      class CarePlanClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_care_plan
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_care_plan_client_read_test
        test from: :us_quality_core_v100_care_plan_patient_category_client_search_test
      end
    end
  end
end
