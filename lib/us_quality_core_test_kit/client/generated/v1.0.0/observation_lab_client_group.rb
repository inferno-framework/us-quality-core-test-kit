  ...
  module Client
    module USQualityCoreClientV100
      class ObservationLabClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_observation_lab
...
conforming to the US Quality Core Laboratory Result Observation.
...
do support it, they must support the US Quality Core Laboratory Result Observation and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_observation_lab_client_read_test
        test from: :us_quality_core_v100_observation_lab_patient_category_status_client_search_test
        test from: :us_quality_core_v100_observation_lab_patient_category_client_search_test
        test from: :us_quality_core_v100_observation_lab_patient_category_date_client_search_test
        test from: :us_quality_core_v100_observation_lab_patient_code_client_search_test
      end
    end
  end
end
