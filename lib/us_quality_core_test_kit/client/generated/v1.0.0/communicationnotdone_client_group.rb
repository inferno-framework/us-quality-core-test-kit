  ...
  module Client
    module USQualityCoreClientV100
      class CommunicationnotdoneClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_communicationnotdone
...
conforming to the US Quality Core Communication Not Done.
...
do support it, they must support the US Quality Core Communication Not Done and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_communicationnotdone_client_read_test
        test from: :us_quality_core_v100_communicationnotdone_subject_client_search_test
        test from: :us_quality_core_v100_communicationnotdone_subject_topic_client_search_test
      end
    end
  end
end
