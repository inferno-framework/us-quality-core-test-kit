  ...
  module Client
    module USQualityCoreClientV100
      class MedicationdispenseClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_medicationdispense
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_medicationdispense_client_read_test
        test from: :us_quality_core_v100_medicationdispense_patient_status_client_search_test
        test from: :us_quality_core_v100_medicationdispense_patient_client_search_test
      end
    end
  end
end
