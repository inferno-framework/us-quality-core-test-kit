  ...
  module Client
    module USQualityCoreClientV100
      class CareTeamClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_care_team
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_care_team_client_read_test
        test from: :us_quality_core_v100_care_team_patient_status_client_search_test
      end
    end
  end
end
