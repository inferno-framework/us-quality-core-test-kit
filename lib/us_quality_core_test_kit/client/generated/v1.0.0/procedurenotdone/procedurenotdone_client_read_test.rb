  ...
  module Client
    module USQualityCoreClientV100
      class ProcedurenotdoneClientReadTest < Inferno::Test
        ...
        id :us_quality_core_v100_procedurenotdone_client_read_test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core Procedure Not Done: `Procedure/usqualitycore-procedurenotdone`."
        end
