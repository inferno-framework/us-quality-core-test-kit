  ...
  module Client
    module USQualityCoreClientV100
      class MedicationadministrationnotdoneClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_medicationadministrationnotdone
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_medicationadministrationnotdone_client_read_test
        test from: :us_quality_core_v100_medicationadministrationnotdone_patient_status_client_search_test
        test from: :us_quality_core_v100_medicationadministrationnotdone_patient_client_search_test
        test from: :us_quality_core_v100_medicationadministrationnotdone_patient_code_client_search_test
        test from: :us_quality_core_v100_medicationadministrationnotdone_patient_effective_time_client_search_test
      end
    end
  end
end
