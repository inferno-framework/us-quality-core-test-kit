  ...
  module Client
    module USQualityCoreClientV100
      class MedicationprohibitedClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_medicationprohibited
...
conforming to the US Quality Core Medication Prohibited.
...
do support it, they must support the US Quality Core Medication Prohibited and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_medicationprohibited_client_read_test
        test from: :us_quality_core_v100_medicationprohibited_patient_intent_do_not_perform_client_search_test
        test from: :us_quality_core_v100_medicationprohibited_patient_intent_client_search_test
      end
    end
  end
end
