  ...
  module Client
    module USQualityCoreClientV100
      class WaitGroup < Inferno::TestGroup
        ...
        id :us_quality_core_client_access_group_v100
        title 'Client Access'
        description %(
        ...
        def suite_id
          ...
          'us_quality_core_client_v100'
        end

        group do
          id :us_quality_core_client_wait_group_v100
          title 'Perform Data Access'

          test do
            id :us_quality_core_client_wait_test_v100
