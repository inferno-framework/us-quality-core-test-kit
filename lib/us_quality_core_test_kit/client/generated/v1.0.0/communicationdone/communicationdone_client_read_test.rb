  ...
  module Client
    module USQualityCoreClientV100
      class CommunicationdoneClientReadTest < Inferno::Test
        ...
        id :us_quality_core_v100_communicationdone_client_read_test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core CommunicationDone: `Communication/usqualitycore-communicationdone`."
        end
        ...
        run do
          ...
          requests_for_id = filter_requests_by_resource_id(requests, 'usqualitycore-communicationdone')
