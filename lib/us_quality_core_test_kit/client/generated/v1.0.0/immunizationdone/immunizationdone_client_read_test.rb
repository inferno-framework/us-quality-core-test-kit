  ...
  module Client
    module USQualityCoreClientV100
      class ImmunizationdoneClientReadTest < Inferno::Test
        ...
        id :us_quality_core_v100_immunizationdone_client_read_test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core Immunization Done: `Immunization/usqualitycore-immunizationdone`."
        end
