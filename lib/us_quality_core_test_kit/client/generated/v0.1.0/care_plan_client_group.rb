  ...
  module Client
    module USQualityCoreClientV010
      class CarePlanClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v010_care_plan
...
conforming to the US Quality Core CarePlan.
...
do support it, they must support the US Quality Core CarePlan and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v010_care_plan_client_read_test
        test from: :us_quality_core_v010_care_plan_patient_category_client_search_test
      end
    end
  end
end
