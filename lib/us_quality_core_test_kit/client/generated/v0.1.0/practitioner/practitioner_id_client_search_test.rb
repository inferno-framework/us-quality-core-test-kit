  ...
  module Client
    module USQualityCoreClientV010
      class PractitionerIdClientSearchTest < Inferno::Test
        ...
        id :us_quality_core_v010_practitioner_id_client_search_test

        title 'SHALL support _id search of Practitioner'

        description %(
          The client demonstrates SHALL support for searching _id on Practitioner.
        )
