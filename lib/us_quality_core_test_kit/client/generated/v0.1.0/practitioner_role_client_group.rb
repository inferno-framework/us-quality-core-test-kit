...
require_relative 'practitioner_role/practitioner_role_id_client_search_test'

module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV010
      class PractitionerRoleClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v010_practitioner_role
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v010_practitioner_role_client_read_test
        test from: :us_quality_core_v010_practitioner_role_id_client_search_test
      end
    end
  end
end
