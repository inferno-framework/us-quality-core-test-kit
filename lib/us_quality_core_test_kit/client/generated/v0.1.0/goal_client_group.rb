  ...
  module Client
    module USQualityCoreClientV010
      class GoalClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v010_goal
...
conforming to the US Quality Core Goal.
...
do support it, they must support the US Quality Core Goal and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v010_goal_client_read_test
        test from: :us_quality_core_v010_goal_patient_client_search_test
      end
    end
  end
end
