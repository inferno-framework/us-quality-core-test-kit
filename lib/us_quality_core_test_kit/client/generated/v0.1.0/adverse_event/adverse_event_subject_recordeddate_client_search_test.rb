  ...
  module Client
    module USQualityCoreClientV010
      class AdverseEventSubjectRecordeddateClientSearchTest < Inferno::Test
        ...
        id :us_quality_core_v010_adverse_event_subject_recordeddate_client_search_test

        title 'SHALL support subject + recordedDate search of AdverseEvent'

        description %(
          The client demonstrates SHALL support for searching subject + recordedDate on AdverseEvent.
        )
