...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV010
      class LocationIdClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v010_location_id_client_search_test

        title 'SHALL support _id search of Location'

        description %(
          The client demonstrates SHALL support for searching _id on Location.
        )
