  ...
  module Client
    module USQualityCoreClientV010
      class ObservationClinicalResultClientReadTest < Inferno::Test
        ...
        id :us_quality_core_v010_observation_clinical_result_client_read_test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core Observation Clinical Result: `Observation/us-quality-core-test-kit-observation-clinical-result`, `Observation/us-quality-core-test-kit-observation-lab`."
        end
