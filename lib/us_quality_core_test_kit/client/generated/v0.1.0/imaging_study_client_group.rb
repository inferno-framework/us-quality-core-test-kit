  ...
  module Client
    module USQualityCoreClientV010
      class ImagingStudyClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v010_imaging_study
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v010_imaging_study_client_read_test
        test from: :us_quality_core_v010_imaging_study_patient_client_search_test
        test from: :us_quality_core_v010_imaging_study_patient_procedure_code_client_search_test
      end
    end
  end
end
