...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV010
      class ServicenotrequestedPatientClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v010_servicenotrequested_patient_client_search_test

        title 'SHALL support patient search of Servicenotrequested'

        description %(
          The client demonstrates SHALL support for searching patient on Servicenotrequested.
        )
