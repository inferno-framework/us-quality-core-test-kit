...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV010
      class ServicenotrequestedIdClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v010_servicenotrequested_id_client_search_test

        title 'SHALL support _id search of Servicenotrequested'

        description %(
          The client demonstrates SHALL support for searching _id on Servicenotrequested.
        )
