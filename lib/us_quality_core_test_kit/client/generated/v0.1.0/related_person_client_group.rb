  ...
  module Client
    module USQualityCoreClientV010
      class RelatedPersonClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v010_related_person
...
conforming to the US Quality Core RelatedPerson.
...
do support it, they must support the US Quality Core RelatedPerson and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v010_related_person_client_read_test
        test from: :us_quality_core_v010_related_person_patient_client_search_test
        test from: :us_quality_core_v010_related_person_id_client_search_test
      end
    end
  end
end
