  ...
  module Client
    module USQualityCoreClientV010
      class CoverageClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v010_coverage
...
conforming to the US Quality Core Coverage.
...
do support it, they must support the US Quality Core Coverage and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v010_coverage_client_read_test
        test from: :us_quality_core_v010_coverage_patient_client_search_test
      end
    end
  end
end
