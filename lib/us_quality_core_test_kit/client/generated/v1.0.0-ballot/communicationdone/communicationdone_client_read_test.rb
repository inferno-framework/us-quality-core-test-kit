  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class CommunicationdoneClientReadTest < Inferno::Test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core CommunicationDone Profile: `Communication/usqualitycore-communicationdone`."
        end
