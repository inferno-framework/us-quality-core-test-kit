...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class CommunicationdoneSubjectClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_communicationdone_subject_client_search_test

        title 'SHALL support subject search of Communicationdone'

        description %(
          The client demonstrates SHALL support for searching subject on Communicationdone.
        )
