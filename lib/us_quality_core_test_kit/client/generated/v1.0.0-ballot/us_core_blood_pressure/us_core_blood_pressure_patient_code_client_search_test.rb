...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class UsCoreBloodPressurePatientCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_us_core_blood_pressure_patient_code_client_search_test

        title 'SHALL support patient + code search of UsCoreBloodPressure'

        description %(
          The client demonstrates SHALL support for searching patient + code on UsCoreBloodPressure.
        )
