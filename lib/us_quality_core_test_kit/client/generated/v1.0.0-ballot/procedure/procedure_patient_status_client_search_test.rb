  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class ProcedurePatientStatusClientSearchTest < Inferno::Test
        ...
        id :us_quality_core_v100_ballot_procedure_patient_status_client_search_test

        title 'SHALL support patient + status search of Procedure'

        description %(
          The client demonstrates SHALL support for searching patient + status on Procedure.
        )
