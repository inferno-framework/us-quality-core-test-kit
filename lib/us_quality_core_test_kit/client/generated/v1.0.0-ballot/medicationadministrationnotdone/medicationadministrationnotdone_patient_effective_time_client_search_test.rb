...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class MedicationadministrationnotdonePatientEffectiveTimeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_medicationadministrationnotdone_patient_effective_time_client_search_test

        title 'SHALL support patient + effective-time search of Medicationadministrationnotdone'

        description %(
          The client demonstrates SHALL support for searching patient + effective-time on Medicationadministrationnotdone.
        )
