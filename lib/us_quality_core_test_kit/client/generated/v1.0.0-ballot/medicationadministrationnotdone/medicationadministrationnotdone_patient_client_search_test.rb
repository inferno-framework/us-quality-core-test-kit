...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class MedicationadministrationnotdonePatientClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_medicationadministrationnotdone_patient_client_search_test

        title 'SHALL support patient search of Medicationadministrationnotdone'

        description %(
          The client demonstrates SHALL support for searching patient on Medicationadministrationnotdone.
        )
