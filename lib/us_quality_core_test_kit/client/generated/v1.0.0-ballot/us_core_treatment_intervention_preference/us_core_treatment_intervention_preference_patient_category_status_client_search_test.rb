...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class UsCoreTreatmentInterventionPreferencePatientCategoryStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_us_core_treatment_intervention_preference_patient_category_status_client_search_test

        title 'SHALL support patient + category + status search of UsCoreTreatmentInterventionPreference'

        description %(
          The client demonstrates SHALL support for searching patient + category + status on UsCoreTreatmentInterventionPreference.
        )
