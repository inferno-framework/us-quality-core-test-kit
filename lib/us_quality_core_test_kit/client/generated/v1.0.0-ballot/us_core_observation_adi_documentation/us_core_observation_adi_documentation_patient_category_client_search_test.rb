...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class UsCoreObservationAdiDocumentationPatientCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_us_core_observation_adi_documentation_patient_category_client_search_test

        title 'SHALL support patient + category search of UsCoreObservationAdiDocumentation'

        description %(
          The client demonstrates SHALL support for searching patient + category on UsCoreObservationAdiDocumentation.
        )
