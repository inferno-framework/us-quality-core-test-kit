  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class MedicationdispensePatientStatusClientSearchTest < Inferno::Test
        ...
        id :us_quality_core_v100_ballot_medicationdispense_patient_status_client_search_test

        title 'SHALL support patient + status search of Medicationdispense'

        description %(
          The client demonstrates SHALL support for searching patient + status on Medicationdispense.
        )
