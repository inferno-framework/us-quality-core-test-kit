  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class PediatricWeightForHeightPatientCategoryStatusClientSearchTest < Inferno::Test
        ...
        id :us_quality_core_v100_ballot_pediatric_weight_for_height_patient_category_status_client_search_test

        title 'SHALL support patient + category + status search of PediatricWeightForHeight'

        description %(
          The client demonstrates SHALL support for searching patient + category + status on PediatricWeightForHeight.
        )
