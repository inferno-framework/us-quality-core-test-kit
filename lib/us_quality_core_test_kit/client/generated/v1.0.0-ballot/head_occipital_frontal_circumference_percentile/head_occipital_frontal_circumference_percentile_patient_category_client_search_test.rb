...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class HeadOccipitalFrontalCircumferencePercentilePatientCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_head_occipital_frontal_circumference_percentile_patient_category_client_search_test

        title 'SHALL support patient + category search of HeadOccipitalFrontalCircumferencePercentile'

        description %(
          The client demonstrates SHALL support for searching patient + category on HeadOccipitalFrontalCircumferencePercentile.
        )
