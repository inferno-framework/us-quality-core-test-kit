...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class HeadOccipitalFrontalCircumferencePercentilePatientCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_head_occipital_frontal_circumference_percentile_patient_code_client_search_test

        title 'SHALL support patient + code search of HeadOccipitalFrontalCircumferencePercentile'

        description %(
          The client demonstrates SHALL support for searching patient + code on HeadOccipitalFrontalCircumferencePercentile.
        )
