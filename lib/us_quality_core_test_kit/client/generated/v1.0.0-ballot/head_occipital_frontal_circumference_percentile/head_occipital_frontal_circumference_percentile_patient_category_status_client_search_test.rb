...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class HeadOccipitalFrontalCircumferencePercentilePatientCategoryStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_head_occipital_frontal_circumference_percentile_patient_category_status_client_search_test

        title 'SHALL support patient + category + status search of HeadOccipitalFrontalCircumferencePercentile'

        description %(
          The client demonstrates SHALL support for searching patient + category + status on HeadOccipitalFrontalCircumferencePercentile.
        )
