  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class ObservationScreeningAssessmentPatientCategoryStatusClientSearchTest < Inferno::Test
        ...
        id :us_quality_core_v100_ballot_observation_screening_assessment_patient_category_status_client_search_test

        title 'SHALL support patient + category + status search of ObservationScreeningAssessment'

        description %(
          The client demonstrates SHALL support for searching patient + category + status on ObservationScreeningAssessment.
        )
