  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class ObservationLabPatientCategoryStatusClientSearchTest < Inferno::Test
        ...
        id :us_quality_core_v100_ballot_observation_lab_patient_category_status_client_search_test

        title 'SHALL support patient + category + status search of ObservationLab'

        description %(
          The client demonstrates SHALL support for searching patient + category + status on ObservationLab.
        )
