...
require_relative 'head_occipital_frontal_circumference_percentile/head_occipital_frontal_circumference_percentile_client_read_test'
require_relative 'head_occipital_frontal_circumference_percentile/head_occipital_frontal_circumference_percentile_patient_code_client_search_test'
...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class HeadOccipitalFrontalCircumferencePercentileClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_ballot_head_occipital_frontal_circumference_percentile

        title 'Observation US Core Pediatric Head Occipital Frontal Circumference Percentile'
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_ballot_head_occipital_frontal_circumference_percentile_client_read_test
        test from: :us_quality_core_v100_ballot_head_occipital_frontal_circumference_percentile_patient_code_client_search_test
        test from: :us_quality_core_v100_ballot_head_occipital_frontal_circumference_percentile_patient_category_status_client_search_test
        test from: :us_quality_core_v100_ballot_head_occipital_frontal_circumference_percentile_patient_category_client_search_test
        test from: :us_quality_core_v100_ballot_head_occipital_frontal_circumference_percentile_patient_category_date_client_search_test
      end
    end
  end
end
