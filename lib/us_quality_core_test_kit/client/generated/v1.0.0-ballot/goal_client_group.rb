  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class GoalClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_ballot_goal
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_ballot_goal_client_read_test
        test from: :us_quality_core_v100_ballot_goal_patient_client_search_test
      end
    end
  end
end
