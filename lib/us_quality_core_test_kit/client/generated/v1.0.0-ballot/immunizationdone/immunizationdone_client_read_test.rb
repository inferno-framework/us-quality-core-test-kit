  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class ImmunizationdoneClientReadTest < Inferno::Test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core Immunization Done Profile: `Immunization/usqualitycore-immunization`."
        end
