...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class UsCoreObservationPregnancyintentPatientCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_us_core_observation_pregnancyintent_patient_code_client_search_test

        title 'SHALL support patient + code search of UsCoreObservationPregnancyintent'

        description %(
          The client demonstrates SHALL support for searching patient + code on UsCoreObservationPregnancyintent.
        )
