  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class ServiceprohibitedClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_ballot_serviceprohibited
...
conforming to the US Quality Core Service Prohibited Profile.
...
do support it, they must support the US Quality Core Service Prohibited Profile and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_ballot_serviceprohibited_client_read_test
        test from: :us_quality_core_v100_ballot_serviceprohibited_patient_do_not_perform_client_search_test
        test from: :us_quality_core_v100_ballot_serviceprohibited_id_client_search_test
        test from: :us_quality_core_v100_ballot_serviceprohibited_patient_client_search_test
        test from: :us_quality_core_v100_ballot_serviceprohibited_patient_category_client_search_test
        test from: :us_quality_core_v100_ballot_serviceprohibited_patient_category_authored_client_search_test
        test from: :us_quality_core_v100_ballot_serviceprohibited_patient_code_client_search_test
      end
    end
  end
end
