...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class UsCoreSmokingstatusPatientCategoryDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_us_core_smokingstatus_patient_category_date_client_search_test

        title 'SHALL support patient + category + date search of UsCoreSmokingstatus'

        description %(
          The client demonstrates SHALL support for searching patient + category + date on UsCoreSmokingstatus.
        )
