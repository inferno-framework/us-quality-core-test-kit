...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class UsCoreSmokingstatusPatientCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_us_core_smokingstatus_patient_code_client_search_test

        title 'SHALL support patient + code search of UsCoreSmokingstatus'

        description %(
          The client demonstrates SHALL support for searching patient + code on UsCoreSmokingstatus.
        )
