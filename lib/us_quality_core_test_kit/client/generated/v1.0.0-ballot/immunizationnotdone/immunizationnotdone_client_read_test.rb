  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class ImmunizationnotdoneClientReadTest < Inferno::Test
        ...
        id :us_quality_core_v100_ballot_immunizationnotdone_client_read_test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core Immunization Not Done Profile: `Immunization/usqualitycore-immunizationnotdone`."
        end
        ...
        run do
          ...
          requests_for_id = filter_requests_by_resource_id(requests, 'usqualitycore-immunizationnotdone')
