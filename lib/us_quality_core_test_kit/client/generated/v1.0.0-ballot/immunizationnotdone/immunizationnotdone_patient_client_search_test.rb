...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class ImmunizationnotdonePatientClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_immunizationnotdone_patient_client_search_test

        title 'SHALL support patient search of Immunizationnotdone'

        description %(
          The client demonstrates SHALL support for searching patient on Immunizationnotdone.
        )
