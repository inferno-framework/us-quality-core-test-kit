  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class PediatricBmiForAgePatientCategoryStatusClientSearchTest < Inferno::Test
        ...
        id :us_quality_core_v100_ballot_pediatric_bmi_for_age_patient_category_status_client_search_test

        title 'SHALL support patient + category + status search of PediatricBmiForAge'

        description %(
          The client demonstrates SHALL support for searching patient + category + status on PediatricBmiForAge.
        )
