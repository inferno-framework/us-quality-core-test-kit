...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class ProceduredonePatientDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_proceduredone_patient_date_client_search_test

        title 'SHALL support patient + date search of Proceduredone'

        description %(
          The client demonstrates SHALL support for searching patient + date on Proceduredone.
        )
