...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class ProceduredonePatientStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_proceduredone_patient_status_client_search_test

        title 'SHALL support patient + status search of Proceduredone'

        description %(
          The client demonstrates SHALL support for searching patient + status on Proceduredone.
        )
