...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class MedicationadministrationdonePatientClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_medicationadministrationdone_patient_client_search_test

        title 'SHALL support patient search of Medicationadministrationdone'

        description %(
          The client demonstrates SHALL support for searching patient on Medicationadministrationdone.
        )
