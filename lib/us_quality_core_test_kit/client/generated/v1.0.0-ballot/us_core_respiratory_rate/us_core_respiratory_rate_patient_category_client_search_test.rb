...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class UsCoreRespiratoryRatePatientCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_us_core_respiratory_rate_patient_category_client_search_test

        title 'SHALL support patient + category search of UsCoreRespiratoryRate'

        description %(
          The client demonstrates SHALL support for searching patient + category on UsCoreRespiratoryRate.
        )
