...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class UsCoreBodyWeightPatientCategoryStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_us_core_body_weight_patient_category_status_client_search_test

        title 'SHALL support patient + category + status search of UsCoreBodyWeight'

        description %(
          The client demonstrates SHALL support for searching patient + category + status on UsCoreBodyWeight.
        )
