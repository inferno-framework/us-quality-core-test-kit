...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class TaskdonePatientClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_taskdone_patient_client_search_test

        title 'SHALL support patient search of Taskdone'

        description %(
          The client demonstrates SHALL support for searching patient on Taskdone.
        )
