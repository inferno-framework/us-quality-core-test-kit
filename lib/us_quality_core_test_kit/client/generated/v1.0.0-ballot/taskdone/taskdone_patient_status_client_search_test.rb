...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class TaskdonePatientStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_taskdone_patient_status_client_search_test

        title 'SHALL support patient + status search of Taskdone'
