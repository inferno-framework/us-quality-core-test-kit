...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class ServiceprohibitedPatientCategoryAuthoredClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_serviceprohibited_patient_category_authored_client_search_test

        title 'SHALL support patient + category + authored search of Serviceprohibited'

        description %(
          The client demonstrates SHALL support for searching patient + category + authored on Serviceprohibited.
        )
