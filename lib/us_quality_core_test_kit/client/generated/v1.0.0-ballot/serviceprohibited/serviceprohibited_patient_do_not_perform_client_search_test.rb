...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class ServiceprohibitedPatientDoNotPerformClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_serviceprohibited_patient_do_not_perform_client_search_test

        title 'SHALL support patient + do-not-perform search of Serviceprohibited'

        description %(
          The client demonstrates SHALL support for searching patient + do-not-perform on Serviceprohibited.
        )
