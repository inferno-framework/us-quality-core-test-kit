...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class EncounterPatientDateClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_encounter_patient_date_client_search_test

        title 'SHALL support patient + date search of Encounter'

        description %(
          The client demonstrates SHALL support for searching patient + date on Encounter.
        )
