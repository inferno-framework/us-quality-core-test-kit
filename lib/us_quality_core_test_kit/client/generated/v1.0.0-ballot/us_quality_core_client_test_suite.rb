...
require_relative 'communication_client_group'
require_relative 'communicationdone_client_group'
require_relative 'communicationnotdone_client_group'
...
require_relative 'devicerequested_client_group'
...
require_relative 'immunizationdone_client_group'
require_relative 'medicationadministration_client_group'
require_relative 'medicationadministrationnotdone_client_group'
require_relative 'medicationadministrationdone_client_group'
require_relative 'medicationdispense_client_group'
require_relative 'medicationdispensedeclined_client_group'
require_relative 'medicationdispensedone_client_group'
require_relative 'medicationrequest_client_group'
require_relative 'medicationprohibited_client_group'
require_relative 'medicationrequested_client_group'
require_relative 'nutrition_order_client_group'
require_relative 'observation_clinical_result_client_group'
require_relative 'us_core_observation_adi_documentation_client_group'
require_relative 'us_core_treatment_intervention_preference_client_group'
...
require_relative 'proceduredone_client_group'
...
require_relative 'serviceprohibited_client_group'
require_relative 'servicerequested_client_group'
require_relative 'task_client_group'
require_relative 'taskrejected_client_group'
require_relative 'taskdone_client_group'
  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class USQualityCoreClientTestSuite < Inferno::TestSuite
        ...
        id :us_quality_core_client_v100_ballot

        title 'US Quality Core Client v1.0.0-ballot'

        description %(
          
The US Quality Core Test Kit Client Suite tests client systems for
conformance to the [US Quality Core Implementation Guide](http://hl7.org/fhir/us/quality-core/1.0.0-202609-ballot/en).
...
The tests will not pass unless at least one profile group passes.
        ...
        links [
          ...
          },
          {
            ...
            url: 'http://hl7.org/fhir/us/quality-core/1.0.0-202609-ballot/en'
          }
        ]

        route(:get, METADATA_PATH, USQualityCoreTestKit::Client::MetadataHelper.get_metadata(
          'v100_ballot',
          File.join(__dir__, 'capability_statement_v100_ballot.json.erb')
        ))
        ...
        group do
          id :us_quality_core_client_read_search_group_v100_ballot
...
CapabilityStatement](http://hl7.org/fhir/us/quality-core/1.0.0-202609-ballot/en/CapabilityStatement-us-quality-core-server.html).


          )

          group from: :us_quality_core_client_access_group_v100_ballot

          group from: :us_quality_core_client_v100_ballot_patient
          group from: :us_quality_core_client_v100_ballot_adverse_event
          group from: :us_quality_core_client_v100_ballot_allergy_intolerance
          group from: :us_quality_core_client_v100_ballot_care_plan
          group from: :us_quality_core_client_v100_ballot_care_team
          group from: :us_quality_core_client_v100_ballot_communication
          group from: :us_quality_core_client_v100_ballot_communicationdone
          group from: :us_quality_core_client_v100_ballot_communicationnotdone
          group from: :us_quality_core_client_v100_ballot_condition_encounter_diagnosis
          group from: :us_quality_core_client_v100_ballot_condition_problems_health_concerns
          group from: :us_quality_core_client_v100_ballot_coverage
          group from: :us_quality_core_client_v100_ballot_device
          group from: :us_quality_core_client_v100_ballot_devicerequest
          group from: :us_quality_core_client_v100_ballot_devicerequested
          ...
          group from: :us_quality_core_client_v100_ballot_immunization
          group from: :us_quality_core_client_v100_ballot_immunizationnotdone
          group from: :us_quality_core_client_v100_ballot_immunizationdone
          group from: :us_quality_core_client_v100_ballot_medicationadministration
          group from: :us_quality_core_client_v100_ballot_medicationadministrationnotdone
          group from: :us_quality_core_client_v100_ballot_medicationadministrationdone
          group from: :us_quality_core_client_v100_ballot_medicationdispense
          group from: :us_quality_core_client_v100_ballot_medicationdispensedeclined
          group from: :us_quality_core_client_v100_ballot_medicationdispensedone
          group from: :us_quality_core_client_v100_ballot_medicationrequest
          group from: :us_quality_core_client_v100_ballot_medicationprohibited
          group from: :us_quality_core_client_v100_ballot_medicationrequested
          group from: :us_quality_core_client_v100_ballot_nutrition_order
          group from: :us_quality_core_client_v100_ballot_observation_clinical_result
          group from: :us_quality_core_client_v100_ballot_us_core_observation_adi_documentation
          group from: :us_quality_core_client_v100_ballot_us_core_treatment_intervention_preference
          group from: :us_quality_core_client_v100_ballot_simple_observation
          group from: :us_quality_core_client_v100_ballot_observation_screening_assessment
          group from: :us_quality_core_client_v100_ballot_us_core_observation_pregnancystatus
          group from: :us_quality_core_client_v100_ballot_us_core_observation_pregnancyintent
          group from: :us_quality_core_client_v100_ballot_us_core_smokingstatus
          group from: :us_quality_core_client_v100_ballot_observation_lab
          group from: :us_quality_core_client_v100_ballot_us_core_observation_occupation
          group from: :us_quality_core_client_v100_ballot_us_core_blood_pressure
          group from: :us_quality_core_client_v100_ballot_us_core_bmi
          group from: :us_quality_core_client_v100_ballot_pediatric_bmi_for_age
          group from: :us_quality_core_client_v100_ballot_us_core_body_height
          group from: :us_quality_core_client_v100_ballot_us_core_body_temperature
          group from: :us_quality_core_client_v100_ballot_us_core_body_weight
          group from: :us_quality_core_client_v100_ballot_head_occipital_frontal_circumference_percentile
          group from: :us_quality_core_client_v100_ballot_us_core_heart_rate
          group from: :us_quality_core_client_v100_ballot_us_core_pulse_oximetry
          group from: :us_quality_core_client_v100_ballot_us_core_respiratory_rate
          group from: :us_quality_core_client_v100_ballot_pediatric_weight_for_height
          group from: :us_quality_core_client_v100_ballot_procedure
          group from: :us_quality_core_client_v100_ballot_procedurenotdone
          group from: :us_quality_core_client_v100_ballot_proceduredone
          group from: :us_quality_core_client_v100_ballot_questionnaire_response
          group from: :us_quality_core_client_v100_ballot_related_person
          group from: :us_quality_core_client_v100_ballot_servicerequest
          group from: :us_quality_core_client_v100_ballot_serviceprohibited
          group from: :us_quality_core_client_v100_ballot_servicerequested
          group from: :us_quality_core_client_v100_ballot_task
          group from: :us_quality_core_client_v100_ballot_taskrejected
          group from: :us_quality_core_client_v100_ballot_taskdone
          group from: :us_quality_core_client_v100_ballot_encounter
          group from: :us_quality_core_client_v100_ballot_location
          group from: :us_quality_core_client_v100_ballot_organization
          group from: :us_quality_core_client_v100_ballot_practitioner
          group from: :us_quality_core_client_v100_ballot_practitioner_role
