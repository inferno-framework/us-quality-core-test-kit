...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class DevicerequestedPatientClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_devicerequested_patient_client_search_test

        title 'SHALL support patient search of Devicerequested'

        description %(
          The client demonstrates SHALL support for searching patient on Devicerequested.
        )
