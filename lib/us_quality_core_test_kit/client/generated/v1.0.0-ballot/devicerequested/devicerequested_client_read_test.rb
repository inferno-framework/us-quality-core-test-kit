  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class DevicerequestedClientReadTest < Inferno::Test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core DeviceRequested Profile: `DeviceRequest/usqualitycore-devicerequested`."
        end
