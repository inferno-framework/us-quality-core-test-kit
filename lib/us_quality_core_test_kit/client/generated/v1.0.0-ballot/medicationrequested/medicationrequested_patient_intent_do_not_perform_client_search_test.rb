...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class MedicationrequestedPatientIntentDoNotPerformClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_medicationrequested_patient_intent_do_not_perform_client_search_test

        title 'SHALL support patient + intent + do-not-perform search of Medicationrequested'
