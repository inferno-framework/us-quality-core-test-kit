  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class MedicationrequestedClientReadTest < Inferno::Test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core MedicationRequested Profile: `MedicationRequest/usqualitycore-medicationrequested`."
        end
