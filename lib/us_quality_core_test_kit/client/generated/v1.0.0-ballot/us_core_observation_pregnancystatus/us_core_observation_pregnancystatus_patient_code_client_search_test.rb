...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class UsCoreObservationPregnancystatusPatientCodeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_us_core_observation_pregnancystatus_patient_code_client_search_test

        title 'SHALL support patient + code search of UsCoreObservationPregnancystatus'

        description %(
          The client demonstrates SHALL support for searching patient + code on UsCoreObservationPregnancystatus.
        )
