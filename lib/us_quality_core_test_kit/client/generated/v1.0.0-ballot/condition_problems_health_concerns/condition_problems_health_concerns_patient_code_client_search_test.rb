  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class ConditionProblemsHealthConcernsPatientCodeClientSearchTest < Inferno::Test
        ...
        id :us_quality_core_v100_ballot_condition_problems_health_concerns_patient_code_client_search_test

        title 'SHALL support patient + code search of ConditionProblemsHealthConcerns'

        description %(
          The client demonstrates SHALL support for searching patient + code on ConditionProblemsHealthConcerns.
        )
