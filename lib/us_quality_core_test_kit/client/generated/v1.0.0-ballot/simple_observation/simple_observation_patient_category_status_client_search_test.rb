  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class SimpleObservationPatientCategoryStatusClientSearchTest < Inferno::Test
        ...
        id :us_quality_core_v100_ballot_simple_observation_patient_category_status_client_search_test

        title 'SHALL support patient + category + status search of SimpleObservation'

        description %(
          The client demonstrates SHALL support for searching patient + category + status on SimpleObservation.
        )
