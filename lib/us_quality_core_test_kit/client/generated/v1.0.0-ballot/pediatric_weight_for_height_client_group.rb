  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class PediatricWeightForHeightClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_ballot_pediatric_weight_for_height
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_ballot_pediatric_weight_for_height_client_read_test
        test from: :us_quality_core_v100_ballot_pediatric_weight_for_height_patient_code_client_search_test
        test from: :us_quality_core_v100_ballot_pediatric_weight_for_height_patient_category_status_client_search_test
        test from: :us_quality_core_v100_ballot_pediatric_weight_for_height_patient_category_client_search_test
        test from: :us_quality_core_v100_ballot_pediatric_weight_for_height_patient_category_date_client_search_test
      end
    end
  end
end
