  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class DeviceprohibitedClientReadTest < Inferno::Test
        ...
        id :us_quality_core_v100_ballot_deviceprohibited_client_read_test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core Device Prohibited Profile: `DeviceRequest/usqualitycore-deviceprohibited`."
        end
