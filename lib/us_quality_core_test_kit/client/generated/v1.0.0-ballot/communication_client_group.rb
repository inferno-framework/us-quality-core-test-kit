...
require_relative 'communication/communication_subject_status_client_search_test'

module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class CommunicationClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_ballot_communication
...
conforming to the US Quality Core Communication Profile.
...
do support it, they must support the US Quality Core Communication Profile and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_ballot_communication_client_read_test
        test from: :us_quality_core_v100_ballot_communication_subject_client_search_test
        test from: :us_quality_core_v100_ballot_communication_subject_topic_client_search_test
        test from: :us_quality_core_v100_ballot_communication_subject_status_client_search_test
      end
    end
  end
end
