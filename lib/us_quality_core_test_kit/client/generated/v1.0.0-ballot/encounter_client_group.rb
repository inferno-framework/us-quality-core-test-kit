  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class EncounterClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_ballot_encounter
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_ballot_encounter_client_read_test
        test from: :us_quality_core_v100_ballot_encounter_patient_client_search_test
        test from: :us_quality_core_v100_ballot_encounter_id_client_search_test
        test from: :us_quality_core_v100_ballot_encounter_patient_type_client_search_test
        test from: :us_quality_core_v100_ballot_encounter_patient_date_client_search_test
      end
    end
  end
end
