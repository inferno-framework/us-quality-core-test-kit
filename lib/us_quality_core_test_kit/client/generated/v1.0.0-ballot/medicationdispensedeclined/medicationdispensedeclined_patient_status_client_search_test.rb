...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class MedicationdispensedeclinedPatientStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_medicationdispensedeclined_patient_status_client_search_test

        title 'SHALL support patient + status search of Medicationdispensedeclined'

        description %(
          The client demonstrates SHALL support for searching patient + status on Medicationdispensedeclined.
        )
