...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class AdverseEventSubjectClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_adverse_event_subject_client_search_test

        title 'SHALL support subject search of AdverseEvent'

        description %(
          The client demonstrates SHALL support for searching subject on AdverseEvent.
        )
