  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class ConditionProblemsHealthConcernsClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_ballot_condition_problems_health_concerns
...
conforming to the US Quality Core Condition Problems Health Concerns Profile.
...
do support it, they must support the US Quality Core Condition Problems Health Concerns Profile and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_ballot_condition_problems_health_concerns_client_read_test
        test from: :us_quality_core_v100_ballot_condition_problems_health_concerns_patient_category_client_search_test
        test from: :us_quality_core_v100_ballot_condition_problems_health_concerns_patient_client_search_test
        test from: :us_quality_core_v100_ballot_condition_problems_health_concerns_patient_code_client_search_test
      end
    end
  end
end
