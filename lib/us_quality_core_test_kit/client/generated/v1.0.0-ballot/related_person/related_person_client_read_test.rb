  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class RelatedPersonClientReadTest < Inferno::Test
        ...
        id :us_quality_core_v100_ballot_related_person_client_read_test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core RelatedPerson Profile: `RelatedPerson/usqualitycore-related-person`."
        end
        ...
        run do
          ...
          requests_for_id = filter_requests_by_resource_id(requests, 'usqualitycore-related-person')
