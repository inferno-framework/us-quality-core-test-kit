  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class RelatedPersonPatientClientSearchTest < Inferno::Test
        ...
        id :us_quality_core_v100_ballot_related_person_patient_client_search_test

        title 'SHALL support patient search of RelatedPerson'

        description %(
          The client demonstrates SHALL support for searching patient on RelatedPerson.
        )
