...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class CommunicationnotdoneSubjectClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_communicationnotdone_subject_client_search_test

        title 'SHALL support subject search of Communicationnotdone'

        description %(
          The client demonstrates SHALL support for searching subject on Communicationnotdone.
        )
