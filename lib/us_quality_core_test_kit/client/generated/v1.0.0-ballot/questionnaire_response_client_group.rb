  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class QuestionnaireResponseClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_ballot_questionnaire_response
...
conforming to the US Quality Core QuestionnaireResponse Profile.
...
do support it, they must support the US Quality Core QuestionnaireResponse Profile and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_ballot_questionnaire_response_client_read_test
        test from: :us_quality_core_v100_ballot_questionnaire_response_patient_client_search_test
        test from: :us_quality_core_v100_ballot_questionnaire_response_patient_questionnaire_client_search_test
      end
    end
  end
end
