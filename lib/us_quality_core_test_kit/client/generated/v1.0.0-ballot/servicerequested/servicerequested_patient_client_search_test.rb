...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class ServicerequestedPatientClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_servicerequested_patient_client_search_test

        title 'SHALL support patient search of Servicerequested'

        description %(
          The client demonstrates SHALL support for searching patient on Servicerequested.
        )
