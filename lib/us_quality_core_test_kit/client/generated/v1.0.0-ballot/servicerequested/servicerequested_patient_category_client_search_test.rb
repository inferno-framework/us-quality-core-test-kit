...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class ServicerequestedPatientCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_servicerequested_patient_category_client_search_test

        title 'SHALL support patient + category search of Servicerequested'

        description %(
          The client demonstrates SHALL support for searching patient + category on Servicerequested.
        )
