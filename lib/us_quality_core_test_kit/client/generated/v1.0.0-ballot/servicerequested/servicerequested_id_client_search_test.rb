...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class ServicerequestedIdClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_servicerequested_id_client_search_test

        title 'SHALL support _id search of Servicerequested'

        description %(
          The client demonstrates SHALL support for searching _id on Servicerequested.
        )
