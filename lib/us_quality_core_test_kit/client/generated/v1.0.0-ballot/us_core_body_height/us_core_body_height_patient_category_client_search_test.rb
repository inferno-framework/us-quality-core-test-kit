...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class UsCoreBodyHeightPatientCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_us_core_body_height_patient_category_client_search_test

        title 'SHALL support patient + category search of UsCoreBodyHeight'

        description %(
          The client demonstrates SHALL support for searching patient + category on UsCoreBodyHeight.
        )
