  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class TaskdoneClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_ballot_taskdone
...
conforming to the US Quality Core Task Done Profile.
...
do support it, they must support the US Quality Core Task Done Profile and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_ballot_taskdone_client_read_test
        test from: :us_quality_core_v100_ballot_taskdone_patient_status_client_search_test
        test from: :us_quality_core_v100_ballot_taskdone_patient_client_search_test
        test from: :us_quality_core_v100_ballot_taskdone_patient_code_client_search_test
      end
    end
  end
end
