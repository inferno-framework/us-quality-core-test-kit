...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class UsCoreBodyTemperaturePatientCategoryStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_us_core_body_temperature_patient_category_status_client_search_test

        title 'SHALL support patient + category + status search of UsCoreBodyTemperature'

        description %(
          The client demonstrates SHALL support for searching patient + category + status on UsCoreBodyTemperature.
        )
