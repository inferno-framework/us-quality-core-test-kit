  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class CareTeamClientReadTest < Inferno::Test
        ...
        id :us_quality_core_v100_ballot_care_team_client_read_test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core CareTeam Profile: `CareTeam/usqualitycore-care-team`."
        end
        ...
        run do
          ...
          requests_for_id = filter_requests_by_resource_id(requests, 'usqualitycore-care-team')
