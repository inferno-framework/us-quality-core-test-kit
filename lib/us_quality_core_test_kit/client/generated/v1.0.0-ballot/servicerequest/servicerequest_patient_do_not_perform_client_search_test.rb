...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class ServicerequestPatientDoNotPerformClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_servicerequest_patient_do_not_perform_client_search_test

        title 'SHALL support patient + do-not-perform search of Servicerequest'

        description %(
          The client demonstrates SHALL support for searching patient + do-not-perform on Servicerequest.
        )
