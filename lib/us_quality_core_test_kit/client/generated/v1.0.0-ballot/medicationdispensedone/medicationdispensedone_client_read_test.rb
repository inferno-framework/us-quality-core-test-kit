  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class MedicationdispensedoneClientReadTest < Inferno::Test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core MedicationDispense Done Profile: `MedicationDispense/usqualitycore-medicationdispensedone`."
        end
