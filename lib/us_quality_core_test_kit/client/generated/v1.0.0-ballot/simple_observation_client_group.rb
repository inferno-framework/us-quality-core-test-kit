  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class SimpleObservationClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_ballot_simple_observation
...
conforming to the US Quality Core Simple Observation Profile.
...
do support it, they must support the US Quality Core Simple Observation Profile and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_ballot_simple_observation_client_read_test
        test from: :us_quality_core_v100_ballot_simple_observation_patient_category_status_client_search_test
        test from: :us_quality_core_v100_ballot_simple_observation_patient_category_client_search_test
        test from: :us_quality_core_v100_ballot_simple_observation_patient_category_date_client_search_test
        test from: :us_quality_core_v100_ballot_simple_observation_patient_code_client_search_test
      end
    end
  end
end
