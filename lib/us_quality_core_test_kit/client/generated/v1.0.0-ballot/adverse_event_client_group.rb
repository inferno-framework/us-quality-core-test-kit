  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class AdverseEventClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_ballot_adverse_event
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_ballot_adverse_event_client_read_test
        test from: :us_quality_core_v100_ballot_adverse_event_subject_client_search_test
        test from: :us_quality_core_v100_ballot_adverse_event_subject_event_client_search_test
        test from: :us_quality_core_v100_ballot_adverse_event_subject_recorded_date_client_search_test
      end
    end
  end
end
