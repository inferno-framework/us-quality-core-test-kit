  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class ObservationScreeningAssessmentClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v100_ballot_observation_screening_assessment
...
conforming to the US Quality Core Observation Screening Assessment Profile.
...
do support it, they must support the US Quality Core Observation Screening Assessment Profile and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v100_ballot_observation_screening_assessment_client_read_test
        test from: :us_quality_core_v100_ballot_observation_screening_assessment_patient_category_status_client_search_test
        test from: :us_quality_core_v100_ballot_observation_screening_assessment_patient_category_client_search_test
        test from: :us_quality_core_v100_ballot_observation_screening_assessment_patient_category_date_client_search_test
        test from: :us_quality_core_v100_ballot_observation_screening_assessment_patient_code_client_search_test
      end
    end
  end
end
