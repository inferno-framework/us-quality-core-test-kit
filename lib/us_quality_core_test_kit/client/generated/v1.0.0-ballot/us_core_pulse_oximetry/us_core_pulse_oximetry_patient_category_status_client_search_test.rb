...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class UsCorePulseOximetryPatientCategoryStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_us_core_pulse_oximetry_patient_category_status_client_search_test

        title 'SHALL support patient + category + status search of UsCorePulseOximetry'

        description %(
          The client demonstrates SHALL support for searching patient + category + status on UsCorePulseOximetry.
        )
