  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class ConditionEncounterDiagnosisPatientCodeClientSearchTest < Inferno::Test
        ...
        id :us_quality_core_v100_ballot_condition_encounter_diagnosis_patient_code_client_search_test

        title 'SHALL support patient + code search of ConditionEncounterDiagnosis'

        description %(
          The client demonstrates SHALL support for searching patient + code on ConditionEncounterDiagnosis.
        )
