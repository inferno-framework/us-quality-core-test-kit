  ...
  module Client
    module USQualityCoreClientV100_BALLOT
      class ProcedurenotdoneClientReadTest < Inferno::Test
        ...
        id :us_quality_core_v100_ballot_procedurenotdone_client_read_test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core Procedure Not Done Profile: `Procedure/usqualitycore-procedurenotdone`."
        end
        ...
        run do
          ...
          requests_for_id = filter_requests_by_resource_id(requests, 'usqualitycore-procedurenotdone')
