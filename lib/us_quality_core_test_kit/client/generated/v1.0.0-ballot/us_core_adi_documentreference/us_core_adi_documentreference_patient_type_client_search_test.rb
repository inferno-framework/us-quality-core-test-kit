...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class UsCoreAdiDocumentreferencePatientTypeClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_us_core_adi_documentreference_patient_type_client_search_test

        title 'SHALL support patient + type search of UsCoreAdiDocumentreference'

        description %(
          The client demonstrates SHALL support for searching patient + type on UsCoreAdiDocumentreference.
        )
