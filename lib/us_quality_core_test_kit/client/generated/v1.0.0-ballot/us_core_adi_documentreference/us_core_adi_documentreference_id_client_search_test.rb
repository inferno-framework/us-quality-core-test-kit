...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class UsCoreAdiDocumentreferenceIdClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_us_core_adi_documentreference_id_client_search_test

        title 'SHALL support _id search of UsCoreAdiDocumentreference'

        description %(
          The client demonstrates SHALL support for searching _id on UsCoreAdiDocumentreference.
        )
