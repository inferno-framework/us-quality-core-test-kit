...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class UsCoreAdiDocumentreferencePatientClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_us_core_adi_documentreference_patient_client_search_test

        title 'SHALL support patient search of UsCoreAdiDocumentreference'

        description %(
          The client demonstrates SHALL support for searching patient on UsCoreAdiDocumentreference.
        )
