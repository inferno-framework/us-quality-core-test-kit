...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class UsCoreBmiPatientCategoryClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_us_core_bmi_patient_category_client_search_test

        title 'SHALL support patient + category search of UsCoreBmi'

        description %(
          The client demonstrates SHALL support for searching patient + category on UsCoreBmi.
        )
