...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class CommunicationSubjectClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_communication_subject_client_search_test

        title 'SHALL support subject search of Communication'

        description %(
          The client demonstrates SHALL support for searching subject on Communication.
        )
