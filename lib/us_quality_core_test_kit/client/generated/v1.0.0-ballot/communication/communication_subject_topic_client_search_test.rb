...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class CommunicationSubjectTopicClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_communication_subject_topic_client_search_test

        title 'SHALL support subject + topic search of Communication'
