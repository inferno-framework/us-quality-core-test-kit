...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV100_BALLOT
      class CommunicationSubjectStatusClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v100_ballot_communication_subject_status_client_search_test

        title 'SHALL support subject + status search of Communication'

        description %(
          The client demonstrates SHALL support for searching subject + status on Communication.
        )
