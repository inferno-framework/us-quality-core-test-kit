...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class ImmunizationnotdoneNonRequiredSearchParametersClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v050_immunizationnotdone_non_required_search_parameters_client_search_test
