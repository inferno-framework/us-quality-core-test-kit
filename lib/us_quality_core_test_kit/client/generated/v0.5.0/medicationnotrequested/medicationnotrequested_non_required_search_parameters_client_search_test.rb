...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class MedicationnotrequestedNonRequiredSearchParametersClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v050_medicationnotrequested_non_required_search_parameters_client_search_test

        title 'SHOULD only use required search parameters for MedicationRequest'
        ...
        run do
          ...
          skip_if requests.blank?, "Inferno did not receive any search requests for the `MedicationRequest` resource type."
