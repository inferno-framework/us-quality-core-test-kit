  ...
  module Client
    module USQualityCoreClientV050
      class ObservationcancelledClientReadTest < Inferno::Test
        ...
        id :us_quality_core_v050_observationcancelled_client_read_test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core Observation Cancelled Profile: `Observation/usqualitycore-observationcancelled`."
        end
