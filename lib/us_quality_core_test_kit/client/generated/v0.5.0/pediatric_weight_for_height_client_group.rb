...
require_relative 'pediatric_weight_for_height/pediatric_weight_for_height_non_required_search_parameters_client_search_test'

module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class PediatricWeightForHeightClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v050_pediatric_weight_for_height

        title 'Observation US Core Pediatric Weight for Height'
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v050_pediatric_weight_for_height_client_read_test
        test from: :us_quality_core_v050_pediatric_weight_for_height_patient_code_client_search_test
        test from: :us_quality_core_v050_pediatric_weight_for_height_patient_category_status_client_search_test
        test from: :us_quality_core_v050_pediatric_weight_for_height_patient_category_client_search_test
        test from: :us_quality_core_v050_pediatric_weight_for_height_patient_category_date_client_search_test
        test from: :us_quality_core_v050_pediatric_weight_for_height_non_required_search_parameters_client_search_test
      end
    end
  end
end
