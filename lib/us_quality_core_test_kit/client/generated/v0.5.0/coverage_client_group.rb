...
require_relative 'coverage/coverage_non_required_search_parameters_client_search_test'

module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class CoverageClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v050_coverage
...
conforming to the US Quality Core Coverage Profile.
...
do support it, they must support the US Quality Core Coverage Profile and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v050_coverage_client_read_test
        test from: :us_quality_core_v050_coverage_patient_client_search_test
        test from: :us_quality_core_v050_coverage_non_required_search_parameters_client_search_test
      end
    end
  end
end
