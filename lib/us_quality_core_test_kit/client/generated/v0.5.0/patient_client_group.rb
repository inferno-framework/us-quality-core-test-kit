...
require_relative 'patient/patient_non_required_search_parameters_client_search_test'

module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class PatientClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v050_patient
...
conforming to the US Quality Core Patient Profile.
...
do support it, they must support the US Quality Core Patient Profile and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v050_patient_client_read_test
        test from: :us_quality_core_v050_patient_id_client_search_test
        test from: :us_quality_core_v050_patient_non_required_search_parameters_client_search_test
      end
    end
  end
end
