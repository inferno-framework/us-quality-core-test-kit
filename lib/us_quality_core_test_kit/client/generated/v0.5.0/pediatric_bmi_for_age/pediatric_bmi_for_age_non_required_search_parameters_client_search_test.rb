...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class PediatricBmiForAgeNonRequiredSearchParametersClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v050_pediatric_bmi_for_age_non_required_search_parameters_client_search_test
