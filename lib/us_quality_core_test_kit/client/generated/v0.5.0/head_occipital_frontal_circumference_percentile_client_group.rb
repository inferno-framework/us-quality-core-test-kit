  ...
  module Client
    module USQualityCoreClientV050
      class HeadOccipitalFrontalCircumferencePercentileClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v050_head_occipital_frontal_circumference_percentile
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v050_head_occipital_frontal_circumference_percentile_client_read_test
        test from: :us_quality_core_v050_head_occipital_frontal_circumference_percentile_patient_code_client_search_test
