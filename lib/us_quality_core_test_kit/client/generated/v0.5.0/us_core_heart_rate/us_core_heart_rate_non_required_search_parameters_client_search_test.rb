...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class UsCoreHeartRateNonRequiredSearchParametersClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v050_us_core_heart_rate_non_required_search_parameters_client_search_test
