...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class ConditionEncounterDiagnosisNonRequiredSearchParametersClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v050_condition_encounter_diagnosis_non_required_search_parameters_client_search_test
