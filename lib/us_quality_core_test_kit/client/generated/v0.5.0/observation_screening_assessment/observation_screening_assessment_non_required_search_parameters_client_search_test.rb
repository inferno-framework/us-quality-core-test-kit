...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class ObservationScreeningAssessmentNonRequiredSearchParametersClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v050_observation_screening_assessment_non_required_search_parameters_client_search_test
