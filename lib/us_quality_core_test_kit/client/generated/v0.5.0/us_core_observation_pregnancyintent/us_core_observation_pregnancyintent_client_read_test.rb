  ...
  module Client
    module USQualityCoreClientV050
      class UsCoreObservationPregnancyintentClientReadTest < Inferno::Test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Core Observation Pregnancy Intent Profile: `Observation/us-quality-core-test-kit-us-core-observation-pregnancyintent`."
        end
        ...
        run do
          ...
          requests_for_id = filter_requests_by_resource_id(requests, 'us-quality-core-test-kit-us-core-observation-pregnancyintent')
