  ...
  module Client
    module USQualityCoreClientV050
      class FamilyMemberHistoryClientReadTest < Inferno::Test
        ...
        id :us_quality_core_v050_family_member_history_client_read_test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core FamilyMemberHistory Profile: `FamilyMemberHistory/usqualitycore-family-member-history`."
        end
