  ...
  module Client
    module USQualityCoreClientV050
      class FamilyMemberHistoryClientReadTest < Inferno::Test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core FamilyMemberHistory: `FamilyMemberHistory/usqualitycore-family-member-history`."
        end
