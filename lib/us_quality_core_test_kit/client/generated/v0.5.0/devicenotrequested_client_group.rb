...
require_relative 'devicenotrequested/devicenotrequested_non_required_search_parameters_client_search_test'
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v050_devicenotrequested_non_required_search_parameters_client_search_test
      end
    end
  end
end
