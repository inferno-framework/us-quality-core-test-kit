  ...
  module Client
    module USQualityCoreClientV050
      class DocumentReferenceClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v050_document_reference
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v050_document_reference_client_read_test
        test from: :us_quality_core_v050_document_reference_patient_client_search_test
        test from: :us_quality_core_v050_document_reference_id_client_search_test
