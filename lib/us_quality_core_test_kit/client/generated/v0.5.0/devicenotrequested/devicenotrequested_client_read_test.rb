  ...
  module Client
    module USQualityCoreClientV050
      class DevicenotrequestedClientReadTest < Inferno::Test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core Device Not Requested Profile: `DeviceRequest/usqualitycore-deviceprohibited`."
        end
