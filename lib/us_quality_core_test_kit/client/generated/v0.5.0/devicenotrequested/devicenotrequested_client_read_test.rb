  ...
  module Client
    module USQualityCoreClientV050
      class DevicenotrequestedClientReadTest < Inferno::Test
        ...
        id :us_quality_core_v050_devicenotrequested_client_read_test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core Device Not Requested Profile: `DeviceRequest/usqualitycore-devicenotrequested`."
        end
        ...
        run do
          ...
          requests_for_id = filter_requests_by_resource_id(requests, 'usqualitycore-devicenotrequested')
