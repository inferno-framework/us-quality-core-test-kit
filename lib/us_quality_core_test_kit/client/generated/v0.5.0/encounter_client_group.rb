...
require_relative 'encounter/encounter_non_required_search_parameters_client_search_test'

module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class EncounterClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v050_encounter
...
conforming to the US Quality Core Encounter Profile.
...
do support it, they must support the US Quality Core Encounter Profile and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v050_encounter_client_read_test
        test from: :us_quality_core_v050_encounter_patient_client_search_test
        test from: :us_quality_core_v050_encounter_id_client_search_test
        test from: :us_quality_core_v050_encounter_patient_type_client_search_test
        test from: :us_quality_core_v050_encounter_patient_date_client_search_test
        test from: :us_quality_core_v050_encounter_non_required_search_parameters_client_search_test
      end
    end
  end
end
