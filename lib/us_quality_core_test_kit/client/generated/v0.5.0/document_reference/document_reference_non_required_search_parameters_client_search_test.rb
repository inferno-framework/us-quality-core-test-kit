...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class DocumentReferenceNonRequiredSearchParametersClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v050_document_reference_non_required_search_parameters_client_search_test

        title 'SHOULD only use required search parameters for DocumentReference'
        ...
        run do
          ...
          skip_if requests.blank?, "Inferno did not receive any search requests for the `DocumentReference` resource type."
