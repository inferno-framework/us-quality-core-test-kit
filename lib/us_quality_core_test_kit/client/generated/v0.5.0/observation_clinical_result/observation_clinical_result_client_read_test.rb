  ...
  module Client
    module USQualityCoreClientV050
      class ObservationClinicalResultClientReadTest < Inferno::Test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core Observation Clinical Result: `Observation/usqualitycore-observation-clinical-result`, `Observation/usqualitycore-observation-lab`."
        end
