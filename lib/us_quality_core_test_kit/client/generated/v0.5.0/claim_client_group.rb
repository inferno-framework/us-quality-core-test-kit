  ...
  module Client
    module USQualityCoreClientV050
      class ClaimClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v050_claim
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v050_claim_client_read_test
        test from: :us_quality_core_v050_claim_patient_client_search_test
      end
    end
  end
end
