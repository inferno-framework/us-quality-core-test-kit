...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class CareTeamNonRequiredSearchParametersClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v050_care_team_non_required_search_parameters_client_search_test

        title 'SHOULD only use required search parameters for CareTeam'
        ...
        run do
          ...
          skip_if requests.blank?, "Inferno did not receive any search requests for the `CareTeam` resource type."
