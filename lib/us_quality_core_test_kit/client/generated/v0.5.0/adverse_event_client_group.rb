...
require_relative 'adverse_event/adverse_event_non_required_search_parameters_client_search_test'

module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class AdverseEventClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v050_adverse_event
...
conforming to the US Quality Core AdverseEvent Profile.
...
do support it, they must support the US Quality Core AdverseEvent Profile and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v050_adverse_event_client_read_test
        test from: :us_quality_core_v050_adverse_event_subject_client_search_test
        test from: :us_quality_core_v050_adverse_event_subject_event_client_search_test
        test from: :us_quality_core_v050_adverse_event_subject_recorded_date_client_search_test
        test from: :us_quality_core_v050_adverse_event_non_required_search_parameters_client_search_test
      end
    end
  end
end
