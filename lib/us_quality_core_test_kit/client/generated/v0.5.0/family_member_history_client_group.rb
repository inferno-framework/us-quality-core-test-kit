  ...
  module Client
    module USQualityCoreClientV050
      class FamilyMemberHistoryClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v050_family_member_history
...
conforming to the US Quality Core FamilyMemberHistory Profile.
...
do support it, they must support the US Quality Core FamilyMemberHistory Profile and the resource type's search parameters.
