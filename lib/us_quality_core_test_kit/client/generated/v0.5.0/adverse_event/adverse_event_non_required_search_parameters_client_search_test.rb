...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class AdverseEventNonRequiredSearchParametersClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v050_adverse_event_non_required_search_parameters_client_search_test

        title 'SHOULD only use required search parameters for AdverseEvent'
        ...
        run do
          ...
          skip_if requests.blank?, "Inferno did not receive any search requests for the `AdverseEvent` resource type."
