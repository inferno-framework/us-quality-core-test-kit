...
require_relative 'diagnostic_report_lab/diagnostic_report_lab_non_required_search_parameters_client_search_test'

module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class DiagnosticReportLabClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v050_diagnostic_report_lab
...
conforming to the US Quality Core DiagnosticReport Profile for Laboratory Results Reporting Profile.
...
do support it, they must support the US Quality Core DiagnosticReport Profile for Laboratory Results Reporting Profile and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v050_diagnostic_report_lab_client_read_test
        test from: :us_quality_core_v050_diagnostic_report_lab_patient_category_client_search_test
        test from: :us_quality_core_v050_diagnostic_report_lab_patient_client_search_test
        test from: :us_quality_core_v050_diagnostic_report_lab_patient_category_date_client_search_test
        test from: :us_quality_core_v050_diagnostic_report_lab_patient_code_client_search_test
        test from: :us_quality_core_v050_diagnostic_report_lab_non_required_search_parameters_client_search_test
      end
    end
  end
end
