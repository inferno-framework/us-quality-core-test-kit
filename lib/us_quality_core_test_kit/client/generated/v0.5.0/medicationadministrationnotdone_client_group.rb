...
require_relative 'medicationadministrationnotdone/medicationadministrationnotdone_non_required_search_parameters_client_search_test'

module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class MedicationadministrationnotdoneClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v050_medicationadministrationnotdone
...
conforming to the US Quality Core MedicationAdministration Not Done Profile.
...
do support it, they must support the US Quality Core MedicationAdministration Not Done Profile and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v050_medicationadministrationnotdone_client_read_test
        test from: :us_quality_core_v050_medicationadministrationnotdone_patient_status_client_search_test
        test from: :us_quality_core_v050_medicationadministrationnotdone_patient_client_search_test
        test from: :us_quality_core_v050_medicationadministrationnotdone_patient_code_client_search_test
        test from: :us_quality_core_v050_medicationadministrationnotdone_patient_effective_time_client_search_test
        test from: :us_quality_core_v050_medicationadministrationnotdone_non_required_search_parameters_client_search_test
      end
    end
  end
end
