...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class UsCoreBodyHeightNonRequiredSearchParametersClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v050_us_core_body_height_non_required_search_parameters_client_search_test
