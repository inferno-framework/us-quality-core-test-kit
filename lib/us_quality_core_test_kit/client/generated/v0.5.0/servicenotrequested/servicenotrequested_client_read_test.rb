  ...
  module Client
    module USQualityCoreClientV050
      class ServicenotrequestedClientReadTest < Inferno::Test
        ...
        def failure_message
          "Inferno did not receive the expected read request for the target instance of the US Quality Core Service Not Requested: `ServiceRequest/usqualitycore-servicenotrequested`."
        end
