...
require_relative 'us_core_blood_pressure/us_core_blood_pressure_non_required_search_parameters_client_search_test'

module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class UsCoreBloodPressureClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v050_us_core_blood_pressure
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v050_us_core_blood_pressure_client_read_test
        test from: :us_quality_core_v050_us_core_blood_pressure_patient_code_client_search_test
        test from: :us_quality_core_v050_us_core_blood_pressure_patient_category_status_client_search_test
        test from: :us_quality_core_v050_us_core_blood_pressure_patient_category_client_search_test
        test from: :us_quality_core_v050_us_core_blood_pressure_patient_category_date_client_search_test
        test from: :us_quality_core_v050_us_core_blood_pressure_non_required_search_parameters_client_search_test
      end
    end
  end
end
