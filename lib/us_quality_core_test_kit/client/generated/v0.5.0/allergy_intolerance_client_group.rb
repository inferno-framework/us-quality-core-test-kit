...
require_relative 'allergy_intolerance/allergy_intolerance_non_required_search_parameters_client_search_test'

module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class AllergyIntoleranceClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v050_allergy_intolerance
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v050_allergy_intolerance_client_read_test
        test from: :us_quality_core_v050_allergy_intolerance_patient_client_search_test
        test from: :us_quality_core_v050_allergy_intolerance_non_required_search_parameters_client_search_test
      end
    end
  end
end
