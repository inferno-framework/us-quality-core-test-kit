...
require_relative 'observation_clinical_result/observation_clinical_result_non_required_search_parameters_client_search_test'

module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class ObservationClinicalResultClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v050_observation_clinical_result
...
conforming to the US Quality Core Observation Clinical Result Profile.
...
do support it, they must support the US Quality Core Observation Clinical Result Profile and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v050_observation_clinical_result_client_read_test
        test from: :us_quality_core_v050_observation_clinical_result_patient_category_status_client_search_test
        test from: :us_quality_core_v050_observation_clinical_result_patient_category_client_search_test
        test from: :us_quality_core_v050_observation_clinical_result_patient_category_date_client_search_test
        test from: :us_quality_core_v050_observation_clinical_result_patient_code_client_search_test
        test from: :us_quality_core_v050_observation_clinical_result_non_required_search_parameters_client_search_test
      end
    end
  end
end
