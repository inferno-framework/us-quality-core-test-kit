...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class SimpleObservationNonRequiredSearchParametersClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v050_simple_observation_non_required_search_parameters_client_search_test
