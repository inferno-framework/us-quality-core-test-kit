...
require_relative 'medicationdispense/medicationdispense_non_required_search_parameters_client_search_test'

module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class MedicationdispenseClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v050_medicationdispense
...
conforming to the US Quality Core MedicationDispense Profile.
...
do support it, they must support the US Quality Core MedicationDispense Profile and the resource type's search parameters.
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v050_medicationdispense_client_read_test
        test from: :us_quality_core_v050_medicationdispense_patient_status_client_search_test
        test from: :us_quality_core_v050_medicationdispense_patient_client_search_test
        test from: :us_quality_core_v050_medicationdispense_non_required_search_parameters_client_search_test
      end
    end
  end
end
