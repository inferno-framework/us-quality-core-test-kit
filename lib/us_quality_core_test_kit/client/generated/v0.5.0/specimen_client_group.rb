...
require_relative 'specimen/specimen_non_required_search_parameters_client_search_test'

module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class SpecimenClientGroup < Inferno::TestGroup
        id :us_quality_core_client_v050_specimen

        title 'US Core Specimen'
...
Inferno will also look for searches using the following optional parameters:
        ...
        test from: :us_quality_core_v050_specimen_client_read_test
        test from: :us_quality_core_v050_specimen_id_client_search_test
        test from: :us_quality_core_v050_specimen_non_required_search_parameters_client_search_test
      end
    end
  end
end
