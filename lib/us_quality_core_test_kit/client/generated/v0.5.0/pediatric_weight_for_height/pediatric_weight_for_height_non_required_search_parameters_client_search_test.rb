...
module USQualityCoreTestKit
  module Client
    module USQualityCoreClientV050
      class PediatricWeightForHeightNonRequiredSearchParametersClientSearchTest < Inferno::Test
        include TestHelper

        id :us_quality_core_v050_pediatric_weight_for_height_non_required_search_parameters_client_search_test
