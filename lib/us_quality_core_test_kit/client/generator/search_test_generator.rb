...
module USQualityCoreTestKit
  module Client
    class Generator
      class SearchTestGenerator < USQualityCoreTestKit::Generator::SearchTestGenerator
        class << self
        ...
        def title
          "#{conformance_expectation} support #{search_param_name_string} search " \
            "of #{profile_identifier.camelize}"
        end
