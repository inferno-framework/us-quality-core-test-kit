...
module USQualityCoreTestKit
  module Client
    class Generator
      class GroupGenerator < USQualityCoreTestKit::Generator::GroupGenerator
        def template
        ...
        def group_id
          "us_quality_core_client_#{group_metadata.reformatted_version}_#{profile_identifier}"
        end
        ...
        def optional_searches
          group_metadata.searches.reject { |search| search[:expectation] == 'SHALL' }
        end
        ...
        def expected_resource_id
          resource_id = [USQualityCoreTestKit::Generator::Naming.instance_id_for_profile(profile_identifier)]

          resource_id << USQualityCoreTestKit::Generator::Naming.instance_id_for_profile('observation_lab') if profile_identifier == 'observation_clinical_result'
