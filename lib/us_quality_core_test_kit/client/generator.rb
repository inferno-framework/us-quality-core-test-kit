...
require_relative 'generator/example_client_generator'
...
module USQualityCoreTestKit
  module Client
    class Generator
      ...
      def generate
        puts "Generating client suite for #{File.basename(ig_file_name)}..."
      ...
      def extract_metadata
        self.ig_metadata = USQualityCoreTestKit::Generator::IGMetadataExtractor.new(ig_resources).extract
