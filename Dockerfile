...
COPY lib/us_quality_core_test_kit/metadata.rb $INSTALL_PATH/lib/us_quality_core_test_kit/metadata.rb
COPY lib/us_quality_core_test_kit/version.rb $INSTALL_PATH/lib/us_quality_core_test_kit/version.rb
COPY *.gemspec $INSTALL_PATH
